...
public class TF_RenderBlock extends ClassTransformer
{
	...
	public TF_RenderBlock()
	{
		...
		this.mcpMethodNodes.put("renderFaceZNeg | (Lnet/minecraft/block/Block;DDDLnet/minecraft/util/Icon;)V", new Patch(nodes));
		this.obfMethodNodes.put("c | (Laqw;DDDLmr;)V", new Patch(nodes));
		...
		this.mcpMethodNodes.put("renderFaceXPos | (Lnet/minecraft/block/Block;DDDLnet/minecraft/util/Icon;)V", new Patch(nodes));
		this.obfMethodNodes.put("f | (Laqw;DDDLmr;)V", new Patch(nodes));
