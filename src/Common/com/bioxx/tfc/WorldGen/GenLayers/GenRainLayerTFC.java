...
public abstract class GenRainLayerTFC extends GenLayerTFC
{
	...
	protected GenRainLayerTFC parent;
	...
	public static GenLayerTFC[] initializeAllBiomeGenerators(long par0, WorldType par2WorldType)
	{
		...
		var5 = (GenLayerTFC) GenLayerZoomTFC.magnify(1000L, var13, var4);
		...
		GenLayerRainAmount var17 = new GenLayerRainAmount(200L, var6, par2WorldType);
