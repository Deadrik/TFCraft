...
public class TFCBiome extends BiomeGenBase
{
	...
	public static final TFCBiome ocean = new BiomeGenOceanTFC(0).setBiomeName("Ocean").setMinMaxHeight(-0.9F, 0.001F).setBiomeColor(0x0000ff);
	...
	public static final TFCBiome plains = (new BiomeGenPlainsTFC(1)).setBiomeName("TFC Plains").setMinMaxHeight(0.1F, 0.16F).setBiomeColor(0x69dfa0);
	...
	public static final TFCBiome HighPlains = (new BiomeGenPlainsTFC(35)).setBiomeName("TFC High Plains").setMinMaxHeight(0.4F, 0.43F).setBiomeColor(0xa6a41c);
	public static final TFCBiome DeepOcean = new BiomeGenOceanTFC(36).setBiomeName("Deep Ocean").setMinMaxHeight(-1.5F, 0.001F).setBiomeColor(0x3333ff);
