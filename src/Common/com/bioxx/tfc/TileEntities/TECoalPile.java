...
public class TECoalPile extends TileEntity implements IInventory
{
    ...
    public ItemStack takeCoal(int slot)
    {
    ...
    {
        --coalPileOpeners;
        if(coalPileOpeners == 0 && storage[0] == null && storage[1] == null && storage[2] == null && storage[3] == null)
        {
            extinguishFire();
            worldObj.setBlockToAir(xCoord, yCoord, zCoord);
        }
    ...
    public void activateCoke()
    {
        ...
        //Activate the adjacent coal piles
    ...
    public void createCoke(int x, int y, int z, boolean forceComplete)
    {
        if(worldObj.getBlock(x, y, z) == TFCBlocks.coalPile)
        {
            ...
            if(te.isOnFire && (te.fireTimer+TFCOptions.cokePitBurnTime < TFC_Time.getTotalHours() || forceComplete))
            {
                ...
                //Activate the surrounding coal piles
                createCoke(x+1, y, z, forceComplete); createCoke(x-1, y, z, forceComplete);
