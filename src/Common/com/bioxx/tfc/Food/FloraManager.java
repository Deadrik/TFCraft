...
public class FloraManager
{
	...
	static
	{
		...
		//Berry Bushes
		instance.addIndex(new FloraIndex("Wintergreen", TFC_Time.July, TFC_Time.July, TFC_Time.September, TFC_Time.October,
				new ItemStack(TFCItems.WintergreenBerry, 1)).setHangTime(5).setTemp(-18, 28).setBioTemp(0, 20).setRain(500, 4000).setEVT(0f, 1));
		instance.addIndex(new FloraIndex("Blueberry", TFC_Time.July, TFC_Time.July, TFC_Time.July, TFC_Time.September,
				new ItemStack(TFCItems.Blueberry, 1)).setHangTime(2).setTemp(0, 32).setBioTemp(5, 25).setRain(125, 1000));
		instance.addIndex(new FloraIndex("Raspberry", TFC_Time.July, TFC_Time.July, TFC_Time.July, TFC_Time.August,
				new ItemStack(TFCItems.Raspberry, 1)).setHangTime(2).setTemp(0, 30).setBioTemp(5, 25).setRain(250, 2000));
		instance.addIndex(new FloraIndex("Strawberry", TFC_Time.July, TFC_Time.July, TFC_Time.May, TFC_Time.June,
				new ItemStack(TFCItems.Strawberry, 1)).setHangTime(2).setTemp(0, 27).setBioTemp(5, 25).setRain(500, 2000));
		instance.addIndex(new FloraIndex("Blackberry", TFC_Time.July, TFC_Time.July, TFC_Time.June, TFC_Time.September,
				new ItemStack(TFCItems.Blackberry, 1)).setHangTime(2).setTemp(0, 30).setBioTemp(5, 25).setRain(125, 4000).setEVT(0.25f, 4));
		instance.addIndex(new FloraIndex("Bunchberry", TFC_Time.July, TFC_Time.July, TFC_Time.July, TFC_Time.September,
				new ItemStack(TFCItems.Bunchberry, 1)).setHangTime(2).setTemp(0, 18).setBioTemp(0, 20).setRain(125, 2000));
		instance.addIndex(new FloraIndex("Cranberry", TFC_Time.July, TFC_Time.July, TFC_Time.September, TFC_Time.November,
				new ItemStack(TFCItems.Cranberry, 1)).setHangTime(0).setTemp(2, 18).setBioTemp(0, 25).setRain(1000, 4000));
		instance.addIndex(new FloraIndex("Snowberry", TFC_Time.July, TFC_Time.July, TFC_Time.August, TFC_Time.September,
				new ItemStack(TFCItems.Snowberry, 1)).setHangTime(3).setTemp(0, 18).setBioTemp(0, 20).setRain(250, 4000).setEVT(0.125f, 4));
		instance.addIndex(new FloraIndex("Elderberry", TFC_Time.July, TFC_Time.July, TFC_Time.August, TFC_Time.September,
				new ItemStack(TFCItems.Elderberry, 1)).setHangTime(0).setTemp(0, 28).setBioTemp(5, 25).setRain(250, 2000));
		instance.addIndex(new FloraIndex("Gooseberry", TFC_Time.July, TFC_Time.July, TFC_Time.May, TFC_Time.July,
				new ItemStack(TFCItems.Gooseberry, 1)).setHangTime(2).setTemp(0, 28).setBioTemp(5, 25).setRain(250, 2000));
		instance.addIndex(new FloraIndex("Cloudberry", TFC_Time.July, TFC_Time.July, TFC_Time.July, TFC_Time.August,
				new ItemStack(TFCItems.Cloudberry, 1)).setHangTime(0).setTemp(0, 18).setBioTemp(0, 20).setRain(250, 1000).setEVT(0.125f, 4));
	}
