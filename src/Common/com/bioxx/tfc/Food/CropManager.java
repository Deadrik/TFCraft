...
public class CropManager
{
	...
	static
	{
		...
		instance.addIndex(new CropIndex(/*ID*/4, /*Name*/"tomato", /*type*/0, /*time*/23, /*stages*/7, /*minGTemp*/8, /*minATemp*/0, /*nutrientUsage*/1.2f, TFCItems.SeedsTomato).setWaterUsage(1.2f).setOutput1(TFCItems.Tomato, 16).setMultiUse());
		...
		instance.addIndex(new CropIndexPepper(/*ID*/19, /*Name*/"yellowbellpepper", /*type*/2, /*time*/18, /*stages*/6, /*minGTemp*/8, /*minATemp*/0, /*nutrientUsage*/1.2f, TFCItems.SeedsYellowBellPepper).setOutput1(TFCItems.GreenBellPepper, 6).setOutput2(TFCItems.YellowBellPepper, 6).setMultiUse());
		instance.addIndex(new CropIndexPepper(/*ID*/20, /*Name*/"redbellpepper", /*type*/2, /*time*/18, /*stages*/6, /*minGTemp*/8, /*minATemp*/0, /*nutrientUsage*/1.2f, TFCItems.SeedsRedBellPepper).setOutput1(TFCItems.GreenBellPepper, 6).setOutput2(TFCItems.RedBellPepper, 6).setMultiUse());
		...
		instance.addIndex(new CropIndex(/*ID*/25, /*Name*/"sugarcane", /*type*/1, /*time*/96, /*stages*/7, /*minGTemp*/18, /*minATemp*/12, /*nutrientUsage*/0.25f, TFCItems.SeedsSugarcane).setOutput1(TFCItems.Sugarcane, 8));
	}
}
