		...
		else
		{
			if (movingobjectposition.typeOfHit == MovingObjectType.BLOCK)
			{
				...
				if (TFCBlocks.Fungi.canBlockStay(par2World, i, j + 1, k) && par2World.isAirBlock(i, j + 1, k))
				{
					...
					par2World.playSoundEffect((double)((float)i + 0.5F), (double)((float)j + 0.5F), (double)((float)k + 0.5F), TFCBlocks.Fungi.stepSound.func_150496_b(), (TFCBlocks.Fungi.stepSound.getVolume() + 1.0F) / 2.0F, TFCBlocks.Fungi.stepSound.getPitch() * 0.8F);
