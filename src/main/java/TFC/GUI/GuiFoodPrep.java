...
public class GuiFoodPrep extends GuiContainerTFC
{
	...
	{
		fontRendererObj.drawString("10oz", 7, 12, 0x404040);
		fontRendererObj.drawString("4oz", 13, 30, 0x404040);
		fontRendererObj.drawString("4oz", 13, 48, 0x404040);
		fontRendererObj.drawString("2oz", 13, 66, 0x404040);
	...
	public void initGui()
	{
		super.initGui();
		buttonList.clear();
		buttonList.add(new GuiButton(0, guiLeft+56, guiTop + 59, 40, 20, StatCollector.translateToLocal("gui.FoodPrep.CreateMeal")));
	}
