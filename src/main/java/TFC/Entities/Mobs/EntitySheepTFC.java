...
public class EntitySheepTFC extends EntitySheep implements IShearable, IAnimal
{
	...
	protected void dropFewItems(boolean par1, int par2)
	{
		...
		if(this.isAdult())
		{
			...
			this.dropItem(Items.bone, rand.nextInt(5)+2);
		}

		if (this.isBurning())
			this.dropItem(TFCItems.muttonCooked,(int)(ageMod*this.size_mod *(5+rand.nextInt(5))));
		else
			this.dropItem(TFCItems.muttonRaw,(int)(ageMod*this.size_mod *(5+rand.nextInt(5))));
	}
