...
public class EntityPheasantTFC extends EntityChicken implements IAnimal
{
	...
	public void onLivingUpdate()
	{
		...
		if(getGender()==GenderEnum.MALE)
			...
			timeUntilNextEgg = 2; //This prevents the vanilla chicken from ever laying an egg.
	...
	public boolean interact(EntityPlayer par1EntityPlayer)
	{
		...
		//par1EntityPlayer.addChatMessage(new ChatComponentText("12: "+dataWatcher.getWatchableObjectInt(12)+", 15: "+dataWatcher.getWatchableObjectInt(15)));
