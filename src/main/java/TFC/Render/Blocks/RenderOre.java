	...
	public static IIcon getRockTexture(World worldObj, int xCoord, int yCoord, int zCoord)
	{
		...
		catch(Exception ex)
		{
			System.out.println("Ore getRockTexture crash! " +
					"rock1: " + rockLayer1.block.getUnlocalizedName() + "/" + rockLayer1.data2 +
					"rock2: " + rockLayer2.block.getUnlocalizedName() + "/" + rockLayer2.data2 +
					"rock3: " + rockLayer3.block.getUnlocalizedName() + "/" + rockLayer3.data2);
