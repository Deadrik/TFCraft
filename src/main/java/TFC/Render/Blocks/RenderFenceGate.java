...
public class RenderFenceGate  implements ISimpleBlockRenderingHandler 
{
	...
	public boolean renderWorldBlock(IBlockAccess world, int par2, int par3, int par4, Block block, int modelId, RenderBlocks renderer)
	{
		...
		if ((i1 == 2 || i1 == 0) && 
				renderer.blockAccess.getBlock(par2 - 1, par3, par4) instanceof TFC.Blocks.Vanilla.BlockCustomWall &&
				renderer.blockAccess.getBlock(par2 + 1, par3, par4) instanceof TFC.Blocks.Vanilla.BlockCustomWall ||
				(i1 == 3 || i1 == 1) &&
				renderer.blockAccess.getBlock(par2, par3, par4 - 1) instanceof TFC.Blocks.Vanilla.BlockCustomWall &&
				renderer.blockAccess.getBlock(par2, par3, par4 + 1) instanceof TFC.Blocks.Vanilla.BlockCustomWall)
		{
			f -= 0.1875F;
			f1 -= 0.1875F;
