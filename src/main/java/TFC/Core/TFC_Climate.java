...
import TFC.Core.Util.BlockMeta;
...
//		}
	...
	public static BlockMeta getRockLayer(int x, int y, int z, int index)
	{
		return new BlockMeta(manager.getRockLayerAt(x, z, index).block, manager.getRockLayerAt(x, z, index).data2);
	}
