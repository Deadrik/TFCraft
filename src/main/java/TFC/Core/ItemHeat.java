...
public class ItemHeat
{
	...
	public static void SetupItemHeat()
	{
		...
		//Ceramics
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.Sand, 1, 32767), 600, new ItemStack(Blocks.glass, 1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.Sand2, 1, 32767), 600, new ItemStack(Blocks.glass, 1)));
		//Food
		manager.addIndex(new HeatIndex(new ItemStack(Items.porkchop, 1), 200, new ItemStack(Items.cooked_porkchop, 1)).setKeepNBT(true));
		manager.addIndex(new HeatIndex(new ItemStack(Items.beef, 1), 200, new ItemStack(Items.cooked_beef, 1)).setKeepNBT(true));
		...
		manager.addIndex(new HeatIndex(new ItemStack(Items.chicken, 1), 200, new ItemStack(Items.cooked_chicken, 1)).setKeepNBT(true));
		manager.addIndex(new HeatIndex(new ItemStack(Items.fish, 1), 200, new ItemStack(Items.cooked_fished, 1)).setKeepNBT(true));
		manager.addIndex(new HeatIndex(new ItemStack(Items.egg, 1), 140, new ItemStack(TFCItems.EggCooked, 1)).setKeepNBT(true));
		...
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.MealGeneric, 1, 32767), 200, new ItemStack(Items.bowl, 1)));

		//Other
		manager.addIndex(new HeatIndex(new ItemStack(Items.stick, 1, 32767), 80, new ItemStack(Item.getItemFromBlock(TFCBlocks.Torch), 2)));
