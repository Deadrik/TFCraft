...
public class FoodStatsTFC
{
	...
	{
		this.addStats(par1ItemFood.func_150905_g/*getHealAmount*/(new ItemStack(par1ItemFood)), par1ItemFood.func_150906_h/*getSaturationModifier*/(new ItemStack(par1ItemFood)));
	}
