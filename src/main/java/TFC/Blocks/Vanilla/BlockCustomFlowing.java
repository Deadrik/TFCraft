...
public class BlockCustomFlowing extends BlockCustomLiquid
{
	...
	public BlockCustomFlowing(Material par2Material)
	{
		super(par2Material);
	}
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		int var6 = this.func_149804_e(par1World, par2, par3, par4);
		byte var7 = 1;
		...
		if (var6 > 0)
		{
			...
			{
				int var11 = this.func_149804_e(par1World, par2, par3 + 1, par4);
				if (var11 >= 8)
					var10 = var11;
				else
					var10 = var11 + 8;
