...
public abstract class BlockCustomLiquid extends BlockLiquid
{
	 ...
	 */
	public static float getLiquidHeightPercent(int par0)
	{
		if (par0 >= 8)
			par0 = 0;
	 ...
	 */
	protected int func_149804_e/*getFlowDecay*/(World par1World, int par2, int par3, int par4)
	{
	...
	public boolean canSustainPlant(IBlockAccess world, int x, int y, int z, ForgeDirection direction, IPlantable plantable)
	{
		...
		case Plains: return (Block)this == Blocks.grass || this == Blocks.dirt;
		case Water:  return world.getBlock(x, y, z).getMaterial() == Material.water && world.getBlockMetadata(x, y, z) == 0;
		case Beach:
			boolean isBeach = ((Block)this == Blocks.grass || this == Blocks.dirt || this == Blocks.sand);
	...
	public void setBlockforLava(World par1World, int par2, int par3, int par4, int typeOfLava){
		...
		if(rockLayer3.block == TFCBlocks.StoneIgIn && (meta == 2||meta == 1))
			felsicLava = false;
		else if(rockLayer3.block == TFCBlocks.StoneIgEx && (meta == 1||meta==2))
			felsicLava = false;
