...
public class WorldGenOre implements IWorldGenerator
{
	...
	public void generate2(Random rand, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider)
	{
		...
		createOreVein(TFCBlocks.Ore, 0, baseRocks,//IgEx and Sandstone, veins
				/*rarity*/100,/*veinSize*/80,/*veinAmt*/55,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Native Copper");
		...
		createOreVein(TFCBlocks.Ore, 1, baseRocks,//Ig veins
				/*rarity*/130,/*veinSize*/35,/*veinAmt*/45,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/20,
				world, rand, chunkX, chunkZ, Min, Max, "Native Gold");

		//============Hematite
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneIgEx, -1);
		createOreVein(TFCBlocks.Ore, 3, baseRocks,//IgEx veins
				/*rarity*/100,/*veinSize*/80,/*veinAmt*/42,/*height*/height,/*diameter*/100,/*vDensity*/40,/*hDensity*/30,
				world, rand, chunkX, chunkZ, Min, Max, "Hematite");
		...
		createOreVein(TFCBlocks.Ore, 4, baseRocks,//granite and gneiss, veins
				/*rarity*/100,/*veinSize*/80,/*veinAmt*/45,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/30,
				world, rand, chunkX, chunkZ, Min, Max, "Native Silver");

		//============Cassiterite
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneIgIn, 0);
		createOreVein(TFCBlocks.Ore, 5, baseRocks,//Granite Veins
				/*rarity*/100,/*veinSize*/85,/*veinAmt*/55,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/50,
				world, rand, chunkX, chunkZ, Min, Max, "Cassiterite");

		//============Cassiterite2
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneIgEx, -1);
		createOreVein(TFCBlocks.Ore, 5, baseRocks,//IgEx Veins
				/*rarity*/140,/*veinSize*/80,/*veinAmt*/45,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/60,
				world, rand, chunkX, chunkZ, Min, Max, "Cassiterite");
		...
		createOreVein(TFCBlocks.Ore, 6, baseRocks,//igex, mm, granite, limestone as veins
				/*rarity*/120,/*veinSize*/80,/*veinAmt*/55,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/60,
				world, rand, chunkX, chunkZ, Min, Max, "Galena");
		...
		createOreVein(TFCBlocks.Ore, 7, baseRocks,//Granite Veins
				/*rarity*/120,/*veinSize*/80,/*veinAmt*/45,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/60,
				world, rand, chunkX, chunkZ, Min, Max, "Bismuthinite");

		//============Garnierite
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneIgIn, 2);
		createOreVein(TFCBlocks.Ore, 8, baseRocks,//Gabbro Veins
				/*rarity*/160,/*veinSize*/40,/*veinAmt*/35,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/10,
				world, rand, chunkX, chunkZ, Min, Max, "Garnierite");
		...
		createOreVein(TFCBlocks.Ore, 9, baseRocks,//limestone and marble veins
				/*rarity*/140,/*veinSize*/80,/*veinAmt*/45,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/20,
				world, rand, chunkX, chunkZ, Min, Max, "Malachite");

		//============Magnetite
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneSed, -1);
		createOreVein(TFCBlocks.Ore, 10, baseRocks,//Sedimentary, Large Cluster
				/*rarity*/180,/*veinSize*/80,/*veinAmt*/36,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Magnetite");

		//============Limonite
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneSed, -1);
		createOreVein(TFCBlocks.Ore, 11, baseRocks,//Sedimentary, Large Cluster
				/*rarity*/180,/*veinSize*/85,/*veinAmt*/40,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Limonite");

		//============Sphalerite
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneMM, -1);
		createOreVein(TFCBlocks.Ore, 12, baseRocks,//mm, veins
				/*rarity*/140,/*veinSize*/80,/*veinAmt*/38,/*height*/height,/*diameter*/100,/*vDensity*/60,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Sphalerite");
		...
		createOreVein(TFCBlocks.Ore, 13, baseRocks,//everything, veins
				/*rarity*/120,/*veinSize*/85,/*veinAmt*/45,/*height*/height,/*diameter*/100,/*vDensity*/50,/*hDensity*/30,
				world, rand, chunkX, chunkZ, Min, Max, "Tetrahedrite");

		//============Bituminous Coal
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneSed, -1);
		createOre(TFCBlocks.Ore, 14, baseRocks,//sedimentary, veins
				/*rarity*/20,/*veinSize*/40,/*veinAmt*/40,/*height*/5,/*diameter*/200,/*vDensity*/90,/*hDensity*/30,
				world, rand, chunkX, chunkZ, Min, Max, "Bituminous Coal");
		...
		createOre(TFCBlocks.Ore, 15, baseRocks,//sedimentary, veins
				/*rarity*/20,/*veinSize*/40,/*veinAmt*/40,/*height*/5,/*diameter*/200,/*vDensity*/90,/*hDensity*/30,
				world, rand, chunkX, chunkZ, Min, Max, "Lignite");

		//============Kaolinite
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneSed, -1);
		createOre(TFCBlocks.Ore2, 0, baseRocks,//sedimentary, large clusters
				/*rarity*/90,/*veinSize*/20,/*veinAmt*/2,/*height*/height,/*diameter*/40,/*vDensity*/80,/*hDensity*/90,
				world, rand, chunkX, chunkZ, Min, Max, "Kaolinite");

		//============Gypsum
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneSed, -1);
		createOre(TFCBlocks.Ore2, 1, baseRocks,//sedimentary, large clusters
				/*rarity*/110,/*veinSize*/40,/*veinAmt*/20,/*height*/height,/*diameter*/40,/*vDensity*/50,/*hDensity*/90,
				world, rand, chunkX, chunkZ, Min, Max, "Gypsum");

		//============Satinspar
		baseRocks.clear();
		baseRocks.put(TFCBlocks.Ore2, 1);
		createOreVein(TFCBlocks.Ore2, 2, baseRocks,//gypsum, small clusters
				/*rarity*/2,/*veinSize*/6,/*veinAmt*/20,/*height*/height,/*diameter*/40,/*vDensity*/40,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Satinspar");
		...
		createOreVein(TFCBlocks.Ore2, 3, baseRocks,//gypsum, small clusters
				/*rarity*/2,/*veinSize*/6,/*veinAmt*/20,/*height*/height,/*diameter*/40,/*vDensity*/40,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Selenite");
		...
		createOreVein(TFCBlocks.Ore2, 4, baseRocks,//gneiss, quartzite, marble, schist, small clusters
				/*rarity*/100,/*veinSize*/6,/*veinAmt*/24,/*height*/height,/*diameter*/40,/*vDensity*/40,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Graphite");

		//============Kimberlite
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneIgIn, 2);
		createOreVein(TFCBlocks.Ore2, 5, baseRocks,//Gabbro, large clusters
				/*rarity*/200,/*veinSize*/40,/*veinAmt*/20,/*height*/height,/*diameter*/40,/*vDensity*/40,/*hDensity*/90,
				world, rand, chunkX, chunkZ, Min, Max, "Kimberlite");

		//============Petrified Wood
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneSed, -1);
		createOre(TFCBlocks.Ore2, 6, baseRocks,//Sedimentary, small clusters 
				/*rarity*/200,/*veinSize*/10,/*veinAmt*/5,/*height*/height,/*diameter*/20,/*vDensity*/10,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Petrified Wood");
		...
		createOre(TFCBlocks.Ore2, 8, baseRocks,//Sedimentary, med clusters 
				/*rarity*/100,/*veinSize*/30,/*veinAmt*/10,/*height*/height,/*diameter*/40,/*vDensity*/60,/*hDensity*/60,
				world, rand, chunkX, chunkZ, Min, Max, "Jet");
		...
		createOre(TFCBlocks.Ore2, 10, baseRocks,//granite, small clusters 
				/*rarity*/100,/*veinSize*/10,/*veinAmt*/10,/*height*/height,/*diameter*/50,/*vDensity*/10,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Pithcblende");
		...
		createOreVein(TFCBlocks.Ore2, 11, baseRocks,//igex, shale, quartzite small clusters
				/*rarity*/60,/*veinSize*/35,/*veinAmt*/30,/*height*/height,/*diameter*/50,/*vDensity*/40,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Cinnabar");

		//============Cryolite
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneIgIn, 0);
		createOre(TFCBlocks.Ore2, 12, baseRocks,//granite, small clusters 
				/*rarity*/100,/*veinSize*/10,/*veinAmt*/20,/*height*/height,/*diameter*/50,/*vDensity*/10,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Cryolite");
		...
		createOre(TFCBlocks.Ore2, 13, baseRocks,//sed, small clusters 
				/*rarity*/100,/*veinSize*/10,/*veinAmt*/20,/*height*/height,/*diameter*/50,/*vDensity*/10,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Saltpeter");

		//============Olivine(Out of Order) must come before serpentine
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneIgIn, 2);
		createOre(TFCBlocks.Ore3, 1, baseRocks,//gabbro, large clusters 
				/*rarity*/80,/*veinSize*/30,/*veinAmt*/14,/*height*/height,/*diameter*/50,/*vDensity*/10,/*hDensity*/60,
				world, rand, chunkX, chunkZ, Min, Max, "Olivine");

		//============Serpentine
		baseRocks.clear();
		baseRocks.put(TFCBlocks.Ore3, 1);
		createOre(TFCBlocks.Ore2, 14, baseRocks,//Olivine, small clusters 
				/*rarity*/2,/*veinSize*/10,/*veinAmt*/8,/*height*/height,/*diameter*/50,/*vDensity*/10,/*hDensity*/60,
				world, rand, chunkX, chunkZ, Min, Max, "Serpentine");

		//============Sylvite
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneSed, 2);
		createOre(TFCBlocks.Ore2, 15, baseRocks,//Rock Salt, large clusters 
				/*rarity*/80,/*veinSize*/40,/*veinAmt*/14,/*height*/height,/*diameter*/50,/*vDensity*/10,/*hDensity*/60,
				world, rand, chunkX, chunkZ, Min, Max, "Sylvite");

		//============Borax
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneSed, 2);
		createOre(TFCBlocks.Ore3, 0, baseRocks,//Rock Salt, large clusters 
				/*rarity*/50,/*veinSize*/50,/*veinAmt*/24,/*height*/height,/*diameter*/200,/*vDensity*/50,/*hDensity*/60,
				world, rand, chunkX, chunkZ, Min, Max, "Borax");
		baseRocks.clear();
		baseRocks.put(TFCBlocks.Ore2, 1);
		createOre(TFCBlocks.Ore3, 0, baseRocks,//Gypsum, small clusters 
				/*rarity*/3,/*veinSize*/12,/*veinAmt*/22,/*height*/height,/*diameter*/200,/*vDensity*/40,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Borax");
		//============Lapis Lazuli
		baseRocks.clear();
		baseRocks.put(TFCBlocks.StoneMM, 5);
		createOre(TFCBlocks.Ore3, 2, baseRocks,//Marble, small clusters 
				/*rarity*/90,/*veinSize*/20,/*veinAmt*/26,/*height*/height,/*diameter*/60,/*vDensity*/40,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Lapis Lazuli");
		...
		createOre(TFCBlocks.Ore, 2, baseRocks,//magnetite, veins
				/*rarity*/10,/*veinSize*/8,/*veinAmt*/10,/*height*/height,/*diameter*/25,/*vDensity*/60,/*hDensity*/40,
				world, rand, chunkX, chunkZ, Min, Max, "Platinum");
	}
