		...
		else
		{
			...
			for (i2 = 0; i2 < 16; ++i2)
				for (j3 = 0; j3 < 16; ++j3)
					for (k4 = 4; k4 < 8; ++k4)
					{
						Block id = world.getBlock(xCoord + i2, yCoord + k4 - 1, zCoord + j3);
						if (var6[(i2 * 16 + j3) * 8 + k4] && (id == Blocks.dirt || id == TFCBlocks.Dirt ||
								id == TFCBlocks.Dirt2 || id == TFCBlocks.Grass || id == TFCBlocks.Grass2 || 
								id == TFCBlocks.ClayGrass || id == TFCBlocks.ClayGrass2 || 
								id == TFCBlocks.Clay || id == TFCBlocks.Clay2 || 
								id == TFCBlocks.Peat || id == TFCBlocks.PeatGrass) && 
