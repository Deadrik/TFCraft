...
public class BiomeDecoratorTFC extends BiomeDecorator
{
	...
	protected void genDecorations(BiomeGenBase bgb)
	{
		...
		for (var2 = 0; var2 < catTailsNum; ++var2)
		{
			...
			if(currentWorld.getBlockId(xCoord, yCoord, zCoord) == Block.waterStill && 
					currentWorld.isBlockOpaqueCube(xCoord, yCoord-1, zCoord))
			{
				currentWorld.setBlock(xCoord, yCoord+1, zCoord, TFCBlocks.Flora, 1, 0x2);
			}
...
//		}
		...
		if (this.generateLakes)
		{
			...
			for (var2 = 0; var2 < 20; ++var2)
			{
				...
				zCoord = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
				yCoord = this.currentWorld.getHeightValue(xCoord, zCoord);
				new WorldGenLiquidsTFC(Blocks.flowing_lava).generate(this.currentWorld, this.randomGenerator, xCoord, yCoord, zCoord);
			}
		}
	}
