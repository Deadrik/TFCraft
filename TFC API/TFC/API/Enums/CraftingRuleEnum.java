...
public enum CraftingRuleEnum
{
    ...
    HITLASTTHREE(StringUtil.localize("gui.Anvil.Rule7"), 0, 0, 2),
    ...
    PUNCHLASTTHREE(StringUtil.localize("gui.Anvil.Rule14"), 3, 0, 2),
    ...
    SHRINKLASTTHREE(StringUtil.localize("gui.Anvil.Rule21"), 6, 0, 2),
    ...
    DRAWLASTTHREE(StringUtil.localize("gui.Anvil.Rule28"), 1, 0, 2),
    ...
    UPSETLASTTHREE(StringUtil.localize("gui.Anvil.Rule35"), 5, 0, 2),
    ...
    BENDLASTTHREE(StringUtil.localize("gui.Anvil.Rule42"), 4, 0, 2),
