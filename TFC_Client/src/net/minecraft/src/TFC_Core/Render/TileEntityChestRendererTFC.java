...
import net.minecraft.src.TFC_Core.TileEntityChestTFC;
...
public class TileEntityChestRendererTFC extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityChestAt(TileEntityChestTFC par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            ...
            {
                ((net.minecraft.src.TFC_Core.Blocks.BlockChestTFC)var10).unifyAdjacentChests(par1TileEntityChest.worldObj, par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                var9 = par1TileEntityChest.getBlockMetadata();
            }
