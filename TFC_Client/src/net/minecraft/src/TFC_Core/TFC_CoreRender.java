...
public class TFC_CoreRender 
{
	...
	public static boolean RenderWoodTrunk(Block block, int i, int j, int k, RenderBlocks renderblocks)
	{
		IBlockAccess blockAccess = renderblocks.blockAccess;
		//Render Thick trees
		if(blockAccess.getBlockMetadata(i, j, k) == 6)
		{
			//renderblocks.overrideBlockTexture = Block.wood.blockIndexInTexture;
			...
			if(blockAccess.getBlockMaterial(i-1, j, k) == Material.leaves)
			{
			...
			if(blockAccess.getBlockMaterial(i, j, k-1) == Material.leaves)
			{
			...
			//renderblocks.renderBlockFire(Block.fire, i, j, k);
	...
	public static boolean RenderWoodSupportBeamH(Block block, int i, int j, int k, RenderBlocks renderblocks)
	{
		...
		if((blockAccess.isBlockOpaqueCube(i, j-1, k) || blockAccess.getBlockId(i, j-1, k) == supportIDv))
		{	
