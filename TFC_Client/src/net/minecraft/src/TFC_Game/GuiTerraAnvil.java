...
public class GuiTerraAnvil extends GuiContainerTFC
{
	...
	public void drawRules(int w, int h)
	{
		...
		for(int i = 0; i < 3; i++)
		{
			...
			switch(AnvilEntity.craftingRules[i])
			{
			case 0:
				fontRenderer.drawString(s + "Hit", w + 209, h+30+yOffset, 0x404040);
				break;
			case 1:
				fontRenderer.drawString(s + "Draw", w + 209, h+30+yOffset, 0x404040);
				break;
			case 2:
				fontRenderer.drawString(s + "Quench", w + 209, h+30+yOffset, 0x404040);
				break;
			case 3:
				fontRenderer.drawString(s + "Punch", w + 209, h+30+yOffset, 0x404040);
				break;
			case 4:
				fontRenderer.drawString(s + "Bend", w + 209, h+30+yOffset, 0x404040);
				break;
			case 5:
				fontRenderer.drawString(s + "Upset", w + 209, h+30+yOffset, 0x404040);
				break;
			case 6:
				fontRenderer.drawString(s + "Shrink", w + 209, h+30+yOffset, 0x404040);
				break;
			case 7:
				fontRenderer.drawString(s + "Weld", w + 209, h+30+yOffset, 0x404040);
				break;
			default:
				break;
			}
