...
//			double blockMaxZ = evt.target.blockZ+1;
			...
			GL11.glDepthMask(false);
			//Draw the mini Box
			drawBox(AxisAlignedBB.getAABBPool().addOrModifyAABBInPool(minX,minY,minZ,maxX,maxY,maxZ).expand(0.002F, 0.002F, 0.002F).getOffsetBoundingBox(-var8, -var10, -var12));
