...
public class RenderFenceGate  implements ISimpleBlockRenderingHandler 
{
			...
			Block block, int modelId, RenderBlocks renderer)
	{
		...
		if ((i1 == 2 || i1 == 0) && 
				Block.blocksList[renderer.blockAccess.getBlockId(par2 - 1, par3, par4)] instanceof TFC.Blocks.Vanilla.BlockCustomWall &&
				Block.blocksList[renderer.blockAccess.getBlockId(par2 + 1, par3, par4)] instanceof TFC.Blocks.Vanilla.BlockCustomWall ||
			    (i1 == 3 || i1 == 1) &&
			    Block.blocksList[renderer.blockAccess.getBlockId(par2, par3, par4 - 1)] instanceof TFC.Blocks.Vanilla.BlockCustomWall &&
			    Block.blocksList[renderer.blockAccess.getBlockId(par2, par3, par4 + 1)] instanceof TFC.Blocks.Vanilla.BlockCustomWall)
		{
			f -= 0.1875F;
			f1 -= 0.1875F;
