...
public class WorldGenAcaciaKoaTrees extends WorldGenerator
{
	...
	int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
	{
		...
		else
		{
			...
			for (var15 = var3[var5] + var8; var14 != var15; var14 += var8)
			{
				...
				if (var16 != 0 && var16 != 18 && var16!= Block.vine.blockID && var16 != TFCBlocks.Leaves2.blockID)
				{
					break;
				}
			}
	...
	void generateLeafNode(int par1, int par2, int par3)
	{
		...
		for (int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4)
		{
			...
			this.genTreeLayer(par1, var4, par3, var6, (byte)1, TFCBlocks.Leaves2.blockID);
		}
	}
	...
	void generateTrunk()
	{
		...
		this.placeBlockLine(var5, var6, TFCBlocks.LogNatural2.blockID);
