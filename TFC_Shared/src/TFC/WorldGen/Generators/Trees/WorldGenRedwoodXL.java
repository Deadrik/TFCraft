...
public class WorldGenRedwoodXL extends WorldGenerator {
			...
			int z)
	{
		...
		world.setBlock(x, y - 1, z, dirtID, meta, 0x2);
		world.setBlock(x - 1, y - 1, z, dirtID, meta, 0x2);
		world.setBlock(x, y - 1, z - 1, dirtID, meta, 0x2);
		world.setBlock(x - 1, y - 1, z - 1, dirtID, meta, 0x2);
