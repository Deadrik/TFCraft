...
public class WorldGenCustomFruitTree extends WorldGenerator
{
    ...
    public boolean generate(World world, Random random, int i, int j, int k)
    {
        ...
        {
            world.setBlock(i, j, k, TFCBlocks.fruitTreeWood.blockID, metaId, 0x2);
            ...
            {
                world.setBlock(i, j+1, k, TFCBlocks.fruitTreeWood.blockID, metaId, 0x2);
                ...
                {
                    world.setBlock(i, j+2, k, TFCBlocks.fruitTreeWood.blockID, metaId, 0x2);
                    ...
                    {
                        world.setBlock(i+1, j+2, k, TFCBlocks.fruitTreeWood.blockID, metaId, 0x2);
                    ...
                    {
                        world.setBlock(i, j+2, k+1, TFCBlocks.fruitTreeWood.blockID, metaId, 0x2);
                    ...
                    {
                        world.setBlock(i, j+3, k, TFCBlocks.fruitTreeWood.blockID, metaId, 0x2);
