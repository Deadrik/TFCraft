...
public class TFCBiome extends BiomeGenBase
{
    ...
    public TFCBiome(int par1)
    {
        ...
        SurfaceMeta = 0;
        Layer1 = 56;
        Layer1Type = TFCBlocks.terraStoneIgIn.blockID;
        Layer1Meta = 0;
        Layer2 = 40;
        Layer2Type = TFCBlocks.terraStoneIgIn.blockID;
        Layer2Meta = 0;
        Layer3 = 20;
        Layer3Type = TFCBlocks.terraStoneIgIn.blockID;
        Layer3Meta = 0;
    ...
    public int DirtID = TFCBlocks.terraDirt.blockID;
    public int ClayID = TFCBlocks.terraClay.blockID;
    public int ClayGrassID = TFCBlocks.terraClayGrass.blockID;
    ...
    public void SetupStone(World world, Random R)
    {
        ...
        if(SurfaceType == TFCBlocks.terraStoneIgIn.blockID)
            TopSoilMetaID = layer1[1];
        else if(SurfaceType == TFCBlocks.terraStoneSed.blockID)
            TopSoilMetaID = layer1[1]+3;
        else if(SurfaceType == TFCBlocks.terraStoneIgEx.blockID)
        ...
        if(TopSoilMetaID < 16)
        {
            this.GrassID = TFCBlocks.terraGrass.blockID;
            this.DirtID = TFCBlocks.terraDirt.blockID;
            this.ClayID = TFCBlocks.terraClay.blockID;
            this.ClayGrassID = TFCBlocks.terraClayGrass.blockID;
        }
        else
        {
            this.GrassID = TFCBlocks.terraGrass2.blockID;
            this.DirtID = TFCBlocks.terraDirt2.blockID;
            this.ClayID = TFCBlocks.terraClay2.blockID;
            this.ClayGrassID = TFCBlocks.terraClayGrass2.blockID;
        }
    ...
    {
        int[][] d = {
                {TFCBlocks.terraStoneIgIn.blockID,0},
                {TFCBlocks.terraStoneIgIn.blockID,0},
                {TFCBlocks.terraStoneIgIn.blockID,1},
                {TFCBlocks.terraStoneIgIn.blockID,2},
                {TFCBlocks.terraStoneSed.blockID,0},
                {TFCBlocks.terraStoneSed.blockID,1},
                {TFCBlocks.terraStoneSed.blockID,2},
                {TFCBlocks.terraStoneSed.blockID,3},
                {TFCBlocks.terraStoneSed.blockID,4},
                {TFCBlocks.terraStoneSed.blockID,5},
                {TFCBlocks.terraStoneSed.blockID,6},
                {TFCBlocks.terraStoneSed.blockID,7},
                {TFCBlocks.terraStoneSed.blockID,8},
                {TFCBlocks.terraStoneSed.blockID,9},
                {TFCBlocks.terraStoneIgEx.blockID,0},
                {TFCBlocks.terraStoneIgEx.blockID,1},
                {TFCBlocks.terraStoneIgEx.blockID,2},
                {TFCBlocks.terraStoneIgEx.blockID,3},
                {TFCBlocks.terraStoneMM.blockID,0},
                {TFCBlocks.terraStoneMM.blockID,1},
                {TFCBlocks.terraStoneMM.blockID,2},
                {TFCBlocks.terraStoneMM.blockID,3},
                {TFCBlocks.terraStoneMM.blockID,4},
                {TFCBlocks.terraStoneMM.blockID,5}};
