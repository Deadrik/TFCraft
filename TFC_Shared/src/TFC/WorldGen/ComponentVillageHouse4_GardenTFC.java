...
public class ComponentVillageHouse4_GardenTFC extends ComponentVillageTFC
{
    private int averageGroundLevel = -1;
    private final boolean isRoofAccessible;

    public ComponentVillageHouse4_GardenTFC(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox, int par4)
    {
        super(par1);
    ...
    public static ComponentVillageHouse4_GardenTFC findValidPlacement(List par0List, Random par1Random, int par2, int par3, int par4, int par5, int par6)
    {
        StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(par2, par3, par4, 0, 0, 0, 5, 6, 5, par5);
        return StructureComponentTFC.findIntersecting(par0List, var7) != null ? null : new ComponentVillageHouse4_GardenTFC(par6, par1Random, var7, par5);
    }
