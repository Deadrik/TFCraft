...
public class WorldGenCustomTallTrees extends WorldGenerator
{
	...
	public boolean generate(World world, Random random, int i, int j, int k)
	{
		...
		if (!(var8 == mod_TFC_Core.terraDirt.blockID || var8 == mod_TFC_Core.terraDirt2.blockID ||var8 == mod_TFC_Core.terraGrass.blockID ||var8 == mod_TFC_Core.terraGrass2.blockID ||
				var8 == mod_TFC_Core.terraClayGrass.blockID ||var8 == mod_TFC_Core.terraClayGrass2.blockID) || j >= world.getHeight() - l - 1)
		{
			return false;
		}
