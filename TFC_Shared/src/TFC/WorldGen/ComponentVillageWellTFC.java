...
public class ComponentVillageWellTFC extends ComponentVillageTFC
{
    private final boolean field_35104_a = true;
    private int averageGroundLevel = -1;

    public ComponentVillageWellTFC(int par1, Random par2Random, int par3, int par4)
    {
        super(par1);
    ...
    {
        StructureVillagePiecesTFC.getNextStructureComponentVillagePath((ComponentVillageStartPieceTFC)par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 1, this.getComponentType());
        StructureVillagePiecesTFC.getNextStructureComponentVillagePath((ComponentVillageStartPieceTFC)par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 3, this.getComponentType());
        StructureVillagePiecesTFC.getNextStructureComponentVillagePath((ComponentVillageStartPieceTFC)par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, 2, this.getComponentType());
        StructureVillagePiecesTFC.getNextStructureComponentVillagePath((ComponentVillageStartPieceTFC)par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
    }
