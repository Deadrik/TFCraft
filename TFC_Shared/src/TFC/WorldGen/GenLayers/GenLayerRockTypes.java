...
{
	public static DataLayer[] biomeArray = new DataLayer[] {DataLayer.Granite, DataLayer.Diorite, DataLayer.Gabbro, 
	...
	public GenLayerRockTypes(long par1, GenLayer par3GenLayer, WorldType par4WorldType)
	{
		super(par1);
