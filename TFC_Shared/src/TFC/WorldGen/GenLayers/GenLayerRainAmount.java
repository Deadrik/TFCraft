...
{
	public static DataLayer[] biomeArray = new DataLayer[] {DataLayer.Rain_62_5,DataLayer.Rain_125,DataLayer.Rain_250,DataLayer.Rain_500,DataLayer.Rain_1000,DataLayer.Rain_2000,DataLayer.Rain_4000,DataLayer.Rain_8000};
	...
	public int[] getInts(int par1, int par2, int par3, int par4)
	{
		...
		for (int var7 = 0; var7 < par4; ++var7)
		{
			for (int var8 = 0; var8 < par3; ++var8)
			{
				...
				if (var9 == 0)
				{
					var6[var8 + var7 * par3] = DataLayer.Rain_500.ID;
				}
				else
				{
