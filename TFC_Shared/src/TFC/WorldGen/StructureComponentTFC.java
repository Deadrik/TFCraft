...
public abstract class StructureComponentTFC
{
    ...
    protected StructureComponentTFC(int par1)
    {
     ...
     */
    public static StructureComponentTFC findIntersecting(List par0List, StructureBoundingBox par1StructureBoundingBox)
    {
        Iterator var2 = par0List.iterator();
        StructureComponentTFC var3;
        ...
        do
        {
            ...
            var3 = (StructureComponentTFC)var2.next();
        }
