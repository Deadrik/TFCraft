...
public class ComponentVillageFieldTFC extends ComponentVillageTFC
{
    private int averageGroundLevel = -1;

    public ComponentVillageFieldTFC(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox, int par4)
    {
        super(par1);
     ...
     */
    public static ComponentVillageFieldTFC findValidPlacement(List par0List, Random par1Random, int par2, int par3, int par4, int par5, int par6)
    {
        StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(par2, par3, par4, 0, 0, 0, 13, 4, 9, par5);
        return canVillageGoDeeper(var7) && StructureComponentTFC.findIntersecting(par0List, var7) == null ? new ComponentVillageFieldTFC(par6, par1Random, var7, par5) : null;
    }
