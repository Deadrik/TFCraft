...
public class WorldGenCustomFruitTree2 extends WorldGenerator
{
    ...
    public boolean generate(World world, Random random, int i, int j, int k)
    {
        ...
        {
            world.setBlockAndMetadata(i, j, k, mod_TFC_Core.fruitTreeWood.blockID, metaId+8);
        ...
        {
            world.setBlockAndMetadata(i, j+1, k, mod_TFC_Core.fruitTreeWood.blockID, metaId+8);
        ...
        {
            world.setBlockAndMetadata(i, j+2, k, mod_TFC_Core.fruitTreeWood.blockID, metaId+8);
            ...
            {
                world.setBlockAndMetadata(i+1, j+2, k, mod_TFC_Core.fruitTreeWood.blockID, metaId+8);
            ...
            {
                world.setBlockAndMetadata(i, j+2, k+1, mod_TFC_Core.fruitTreeWood.blockID, metaId+8);
        ...
        {
            world.setBlockAndMetadata(i, j+3, k, mod_TFC_Core.fruitTreeWood.blockID, metaId+8);
