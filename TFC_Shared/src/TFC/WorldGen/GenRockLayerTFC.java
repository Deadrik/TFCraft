...
public abstract class GenRockLayerTFC extends GenLayerTFC
{
    ...
    public static GenLayerTFC[] initializeAllBiomeGenerators(long par0, WorldType par2WorldType)
    {
        ...
        GenLayerAddIslandRockTFC var10 = new GenLayerAddIslandRockTFC(1L, var9);
        GenLayerZoomTFC var11 = new GenLayerZoomTFC(2001L, var10);
        var10 = new GenLayerAddIslandRockTFC(2L, var11);
        GenLayerAddSnowTFC var12 = new GenLayerAddSnowTFC(2L, var10);
        var11 = new GenLayerZoomTFC(2002L, var12);
        var10 = new GenLayerAddIslandRockTFC(3L, var11);
        var11 = new GenLayerZoomTFC(2003L, var10);
        var10 = new GenLayerAddIslandRockTFC(4L, var11);
        byte var4 = 5;
        ...
        for (int var7 = 0; var7 < var4; ++var7)
        {
            ...
            if (var7 == 0)
            {
                var18 = new GenLayerAddIslandRockTFC(3L, (GenLayerTFC)var18);
            }
        }
