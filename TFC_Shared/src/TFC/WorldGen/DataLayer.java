...
public class DataLayer 
{
	...
	public static DataLayer Shale = new DataLayer(5,TFCBlocks.StoneSed.blockID, 0, "Shale");
	public static DataLayer Claystone = new DataLayer(6,TFCBlocks.StoneSed.blockID, 1, "Claystone");
	public static DataLayer RockSalt = new DataLayer(7,TFCBlocks.StoneSed.blockID, 2, "RockSalt");
	public static DataLayer Limestone = new DataLayer(8,TFCBlocks.StoneSed.blockID, 3, "Limestone");
	public static DataLayer Conglomerate = new DataLayer(9,TFCBlocks.StoneSed.blockID, 4, "Conglomerate");
	public static DataLayer Dolomite = new DataLayer(10,TFCBlocks.StoneSed.blockID, 5, "Dolomite");
	public static DataLayer Chert = new DataLayer(11,TFCBlocks.StoneSed.blockID, 6, "Chert");
	public static DataLayer Chalk = new DataLayer(12,TFCBlocks.StoneSed.blockID, 7, "Chalk");
