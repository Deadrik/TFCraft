...
public class ComponentVillageTorchTFC extends ComponentVillageTFC
{
    private int averageGroundLevel = -1;

    public ComponentVillageTorchTFC(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox, int par4)
    {
        super(par1);
    ...
    public static StructureBoundingBox findValidPlacement(List par0List, Random par1Random, int par2, int par3, int par4, int par5)
    {
        ...
        return StructureComponentTFC.findIntersecting(par0List, var6) != null ? null : var6;
    }
