...
public class MapGenBaseTFC
{
	...
	public void generate(IChunkProvider par1IChunkProvider, World par2World, int par3, int par4, short[] idsBig)
	{
		int var6 = this.range;
	 ...
	 */
	 protected void recursiveGenerate(World par1World, int par2, int par3, int par4, int par5, short[] idsBig) {}
}
