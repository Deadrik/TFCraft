...
public class TFCItems
{
  ...
  //Tier 0
    ...
    public static void Setup()
    {
        ...
        //Tool heads
        BismuthPickaxeHead = new ItemMiscToolHead(TFC_Settings.getIntFor(config,"item","BismuthPickaxeHead",16500)).setUnlocalizedName("Bismuth Pickaxe Head");
        BismuthBronzePickaxeHead = new ItemMiscToolHead(TFC_Settings.getIntFor(config,"item","BismuthBronzePickaxeHead",16501)).setUnlocalizedName("Bismuth Bronze Pickaxe Head");
        BlackBronzePickaxeHead = new ItemMiscToolHead(TFC_Settings.getIntFor(config,"item","BlackBronzePickaxeHead",16502)).setUnlocalizedName("Black Bronze Pickaxe Head");
        BlackSteelPickaxeHead = new ItemMiscToolHead(TFC_Settings.getIntFor(config,"item","BlackSteelPickaxeHead",16503)).setUnlocalizedName("Black Steel Pickaxe Head");
        BlueSteelPickaxeHead = new ItemMiscToolHead(TFC_Settings.getIntFor(config,"item","BlueSteelPickaxeHead",16504)).setUnlocalizedName("Blue Steel Pickaxe Head");
        ...
        WroughtIronPickaxeHead = new ItemMiscToolHead(TFC_Settings.getIntFor(config,"item","WroughtIronPickaxeHead",16507)).setUnlocalizedName("Wrought Iron Pickaxe Head");
        RedSteelPickaxeHead = new ItemMiscToolHead(TFC_Settings.getIntFor(config,"item","RedSteelPickaxeHead",16508)).setUnlocalizedName("Red Steel Pickaxe Head");
        RoseGoldPickaxeHead = new ItemMiscToolHead(TFC_Settings.getIntFor(config,"item","RoseGoldPickaxeHead",16509)).setUnlocalizedName("Rose Gold Pickaxe Head");
        SteelPickaxeHead = new ItemMiscToolHead(TFC_Settings.getIntFor(config,"item","SteelPickaxeHead",16510)).setUnlocalizedName("Steel Pickaxe Head");
        TinPickaxeHead = new ItemMiscToolHead(TFC_Settings.getIntFor(config,"item","TinPickaxeHead",16511)).setUnlocalizedName("Tin Pickaxe Head");
        ZincPickaxeHead = new ItemMiscToolHead(TFC_Settings.getIntFor(config,"item","ZincPickaxeHead",16512)).setUnlocalizedName("Zinc Pickaxe Head");
    ...
    public static void SetupFood(int num)
    {
        ...
        WheatGrain = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","WheatGrain",num++), 1, 0.4F, false,TFC_Textures.FoodSheet, 12).setUnlocalizedName("WheatGrain");
        BarleyGrain = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","BarleyGrain",num++), 1, 0.4F, false,TFC_Textures.FoodSheet, 14).setUnlocalizedName("BarleyGrain");
        OatGrain = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","OatGrain",num++), 1, 0.4F, false,TFC_Textures.FoodSheet, 16).setUnlocalizedName("OatGrain");
        RyeGrain = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","RyeGrain",num++), 1, 0.4F, false,TFC_Textures.FoodSheet, 18).setUnlocalizedName("RyeGrain");
        RiceGrain = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","RiceGrain",num++), 1, 0.4F, false,TFC_Textures.FoodSheet, 20).setUnlocalizedName("RiceGrain");
        MaizeEar = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","MaizeEar",num++), 10, 0.4F, false,TFC_Textures.FoodSheet, 22).setUnlocalizedName("MaizeEar");
        ...
        GreenBellPepper = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","GreenBellPepper",num++), 10, 0.4F, false,TFC_Textures.FoodSheet, 34).setUnlocalizedName("GreenBellPepper");
        YellowBellPepper = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","YellowBellPepper",num++), 10, 0.4F, false,TFC_Textures.FoodSheet, 35).setUnlocalizedName("YellowBellPepper");
        RedBellPepper = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","RedBellPepper",num++), 10, 0.4F, false,TFC_Textures.FoodSheet, 36).setUnlocalizedName("RedBellPepper");
        ...
        WheatWhole = new ItemTerra(TFC_Settings.getIntFor(config,"item","WheatWhole",num++),TFC_Textures.FoodSheet).setUnlocalizedName("WheatWhole");
        BarleyWhole = new ItemTerra(TFC_Settings.getIntFor(config,"item","BarleyWhole",num++),TFC_Textures.FoodSheet).setUnlocalizedName("BarleyWhole");
        OatWhole = new ItemTerra(TFC_Settings.getIntFor(config,"item","OatWhole",num++),TFC_Textures.FoodSheet).setUnlocalizedName("OatWhole");
        RyeWhole = new ItemTerra(TFC_Settings.getIntFor(config,"item","RyeWhole",num++),TFC_Textures.FoodSheet).setUnlocalizedName("RyeWhole");
        RiceWhole = new ItemTerra(TFC_Settings.getIntFor(config,"item","RiceWhole",num++),TFC_Textures.FoodSheet).setUnlocalizedName("RiceWhole");
        ...
        WheatGround = new ItemTerra(TFC_Settings.getIntFor(config,"item","WheatGround",num++),TFC_Textures.FoodSheet).setUnlocalizedName("WheatGround");
        BarleyGround = new ItemTerra(TFC_Settings.getIntFor(config,"item","BarleyGround",num++),TFC_Textures.FoodSheet).setUnlocalizedName("BarleyGround");
        OatGround = new ItemTerra(TFC_Settings.getIntFor(config,"item","OatGround",num++),TFC_Textures.FoodSheet).setUnlocalizedName("OatGround");
        RyeGround = new ItemTerra(TFC_Settings.getIntFor(config,"item","RyeGround",num++),TFC_Textures.FoodSheet).setUnlocalizedName("RyeGround");
        RiceGround = new ItemTerra(TFC_Settings.getIntFor(config,"item","RiceGround",num++),TFC_Textures.FoodSheet).setUnlocalizedName("RiceGround");
        CornmealGround = new ItemTerra(TFC_Settings.getIntFor(config,"item","CornmealGround",num++),TFC_Textures.FoodSheet).setUnlocalizedName("CornmealGround");
        
        WheatDough = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","WheatDough",num++), 1, 0.0F, false,TFC_Textures.FoodSheet, 0).setUnlocalizedName("WheatDough");
        BarleyDough = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","BarleyDough",num++), 1, 0.0F, false,TFC_Textures.FoodSheet, 0).setUnlocalizedName("BarleyDough");
        OatDough = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","OatDough",num++), 1, 0.0F, false,TFC_Textures.FoodSheet, 0).setUnlocalizedName("OatDough");
        RyeDough = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","RyeDough",num++), 1, 0.0F, false,TFC_Textures.FoodSheet, 0).setUnlocalizedName("RyeDough");
        RiceDough = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","RiceDough",num++), 1, 0.0F, false,TFC_Textures.FoodSheet, 0).setUnlocalizedName("RiceDough");
        CornmealDough = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","CornmealDough",num++), 1, 0.0F, false,TFC_Textures.FoodSheet, 0).setUnlocalizedName("CornmealDough");
        
        BarleyBread = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","BarleyBread",num++), 25, 0.6F, false,TFC_Textures.FoodSheet, 43).setUnlocalizedName("BarleyBread");
        OatBread = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","OatBread",num++), 25, 0.6F, false,TFC_Textures.FoodSheet, 44).setUnlocalizedName("OatBread");
        RyeBread = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","RyeBread",num++), 25, 0.6F, false,TFC_Textures.FoodSheet, 45).setUnlocalizedName("RyeBread");
        RiceBread = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","RiceBread",num++), 25, 0.6F, false,TFC_Textures.FoodSheet, 46).setUnlocalizedName("RiceBread");
        CornBread = new ItemTerraFood(TFC_Settings.getIntFor(config,"item","CornBread",num++), 25, 0.6F, false,TFC_Textures.FoodSheet, 47).setUnlocalizedName("CornBread");
        
        num = 18900;
        SeedsWheat = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsWheat",num++),0).setUnlocalizedName("SeedsWheat");
        SeedsBarley = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsBarley",num++),5).setUnlocalizedName("SeedsBarley");
        SeedsRye = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsRye",num++),7).setUnlocalizedName("SeedsRye");
        SeedsOat = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsOat",num++),9).setUnlocalizedName("SeedsOat");
        SeedsRice = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsRice",num++),11).setUnlocalizedName("SeedsRice");
        SeedsMaize = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsMaize",num++),2).setUnlocalizedName("SeedsMaize");
        SeedsPotato = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsPotato",num++),13).setUnlocalizedName("SeedsPotato");
        SeedsOnion = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsOnion",num++),15).setUnlocalizedName("SeedsOnion");
        SeedsCabbage = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsCabbage",num++),16).setUnlocalizedName("SeedsCabbage");
        SeedsGarlic = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsGarlic",num++),17).setUnlocalizedName("SeedsGarlic");
        SeedsCarrot = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsCarrot",num++),18).setUnlocalizedName("SeedsCarrot");
        SeedsSugarcane = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsSugarcane",num++),21).setUnlocalizedName("SeedsSugarcane");
        SeedsHemp = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsHemp",num++),22).setUnlocalizedName("SeedsHemp");
        SeedsTomato = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsTomato",num++),4).setUnlocalizedName("SeedsTomato");
        SeedsYellowBellPepper = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsYellowBellPepper",num++),19).setUnlocalizedName("SeedsYellowBellPepper");
        SeedsRedBellPepper = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsRedBellPepper",num++),20).setUnlocalizedName("SeedsRedBellPepper");
        SeedsSoybean = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsSoybean",num++),21).setUnlocalizedName("SeedsSoybean");
        SeedsGreenbean = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsGreenbean",num++),22).setUnlocalizedName("SeedsGreenbean");
        SeedsSquash = new ItemCustomSeeds(TFC_Settings.getIntFor(config,"item","SeedsSquash",num++),23).setUnlocalizedName("SeedsSquash");
    }
    ...
    public static void SetupArmor(int num)
    {
        ...
        int i = 0;
        BismuthSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("BismuthSheet"));num++;
        BismuthBronzeSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("Bismuth BronzeSheet"));num++;
        BlackBronzeSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("Black BronzeSheet"));num++;
        BlackSteelSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("Black SteelSheet"));num++;
        BlueSteelSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("Blue SteelSheet"));num++;
        BronzeSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("BronzeSheet"));num++;
        CopperSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("CopperSheet"));num++;
        WroughtIronSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("Wrought IronSheet"));num++;
        RedSteelSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("Red SteelSheet"));num++;
        RoseGoldSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("Rose GoldSheet"));num++;
        SteelSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("SteelSheet"));num++;
        TinSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("TinSheet"));num++;
        ZincSheet = ((ItemTerra)new ItemMetalSheet(TFC_Settings.getIntFor(config,"item",NamesNS[i++]+"Sheet",num)).setUnlocalizedName("ZincSheet"));num++;
        ...
        i = 0;
        TFCItems.BismuthUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.BismuthBronzeUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.BlackBronzeUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.BlackSteelUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.BlueSteelUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.BronzeUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.CopperUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.WroughtIronUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.RedSteelUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.RoseGoldUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.SteelUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.TinUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        TFCItems.ZincUnfinishedBoots = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedBoots",num)).setUnlocalizedName(Names[i]+"UnfinishedBoots")); num++;i++;
        i = 0;
        ...
        i = 0;
        TFCItems.BismuthUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.BismuthBronzeUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.BlackBronzeUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.BlackSteelUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.BlueSteelUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.BronzeUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.CopperUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.WroughtIronUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.RedSteelUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.RoseGoldUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.SteelUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.TinUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        TFCItems.ZincUnfinishedGreaves = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedGreaves",num)).setUnlocalizedName(Names[i]+"UnfinishedGreaves")); num++;i++;
        i = 0;
        ...
        i = 0;
        TFCItems.BismuthUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.BismuthBronzeUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.BlackBronzeUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.BlackSteelUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.BlueSteelUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.BronzeUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.CopperUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.WroughtIronUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.RedSteelUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.RoseGoldUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.SteelUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.TinUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        TFCItems.ZincUnfinishedChestplate = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedChestplate",num)).setUnlocalizedName(Names[i]+"UnfinishedChestplate")); num++;i++;
        i = 0;
        ...
        i = 0;
        TFCItems.BismuthUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.BismuthBronzeUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.BlackBronzeUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.BlackSteelUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.BlueSteelUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.BronzeUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.CopperUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.WroughtIronUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.RedSteelUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.RoseGoldUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.SteelUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.TinUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        TFCItems.ZincUnfinishedHelmet = ((ItemUnfinishedArmor)new ItemUnfinishedArmor(TFC_Settings.getIntFor(config,"item",NamesNS[i]+"UnfinishedHelmet",num)).setUnlocalizedName(Names[i]+"UnfinishedHelmet")); num++;i++;
        i = 0;
