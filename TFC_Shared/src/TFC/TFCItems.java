...
public class TFCItems
{
  ...
  //Tier 0
    ...
    public static void Setup()
    {
        ...
        BismuthIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","BismuthIngot",16028), EnumMetalType.BISMUTH).setItemName("BismuthIngot").setIconCoord(0, 3);
        BismuthBronzeIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","BismuthBronzeIngot",16029), EnumMetalType.BISMUTHBRONZE).setItemName("BismuthBronzeIngot").setIconCoord(1, 3);
        BlackBronzeIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","BlackBronzeIngot",16030), EnumMetalType.BLACKBRONZE).setItemName("BlackBronzeIngot").setIconCoord(2, 3);
        BlackSteelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","BlackSteelIngot",16031), EnumMetalType.BLACKSTEEL).setItemName("BlackSteelIngot").setIconCoord(3, 3);
        BlueSteelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","BlueSteelIngot",16032), EnumMetalType.BLUESTEEL).setItemName("BlueSteelIngot").setIconCoord(4, 3);
        BrassIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","BrassIngot",16033), EnumMetalType.BRASS).setItemName("BrassIngot").setIconCoord(5, 3);
        BronzeIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","BronzeIngot",16034), EnumMetalType.BRONZE).setItemName("BronzeIngot").setIconCoord(6, 3);
        CopperIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","CopperIngot",16035), EnumMetalType.COPPER).setItemName("CopperIngot").setIconCoord(7, 3);
        GoldIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","GoldIngot",16036), EnumMetalType.GOLD).setItemName("GoldIngot").setIconCoord(8, 3);
        WroughtIronIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","WroughtIronIngot",16037), EnumMetalType.WROUGHTIRON).setItemName("WroughtIronIngot").setIconCoord(9, 3);
        LeadIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","LeadIngot",16038), EnumMetalType.LEAD).setItemName("LeadIngot").setIconCoord(10, 3);
        NickelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","NickelIngot",16039), EnumMetalType.NICKEL).setItemName("NickelIngot").setIconCoord(0, 4);
        PigIronIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","PigIronIngot",16040), EnumMetalType.PIGIRON).setItemName("PigIronIngot").setIconCoord(1, 4);
        PlatinumIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","PlatinumIngot",16041), EnumMetalType.PLATINUM).setItemName("PlatinumIngot").setIconCoord(2, 4);
        RedSteelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","RedSteelIngot",16042), EnumMetalType.REDSTEEL).setItemName("RedSteelIngot").setIconCoord(3, 4);
        RoseGoldIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","RoseGoldIngot",16043), EnumMetalType.ROSEGOLD).setItemName("RoseGoldIngot").setIconCoord(4, 4);
        SilverIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","SilverIngot",16044), EnumMetalType.SILVER).setItemName("SilverIngot").setIconCoord(5, 4);
        SteelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","SteelIngot",16045), EnumMetalType.STEEL).setItemName("SteelIngot").setIconCoord(6, 4);
        SterlingSilverIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","SterlingSilverIngot",16046), EnumMetalType.STERLINGSILVER).setItemName("SterlingSilverIngot").setIconCoord(7, 4);
        TinIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","TinIngot",16047), EnumMetalType.TIN).setItemName("TinIngot").setIconCoord(8, 4);
        ZincIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","ZincIngot",16048), EnumMetalType.ZINC).setItemName("ZincIngot").setIconCoord(9, 4);

        BismuthIngot2x = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","BismuthIngot2x",16049), EnumMetalType.BISMUTH).setItemName("BismuthIngot2x").setIconCoord(0, 5)).setSize(EnumSize.LARGE);
        BismuthBronzeIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","BismuthBronzeIngot2x",16050), EnumMetalType.BISMUTHBRONZE).setItemName("BismuthBronzeIngot2x").setIconCoord(1, 5)).setSize(EnumSize.LARGE);
        BlackBronzeIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","BlackBronzeIngot2x",16051), EnumMetalType.BLACKBRONZE).setItemName("BlackBronzeIngot2x").setIconCoord(2, 5)).setSize(EnumSize.LARGE);
        BlackSteelIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","BlackSteelIngot2x",16052), EnumMetalType.BLACKSTEEL).setItemName("BlackSteelIngot2x").setIconCoord(3, 5)).setSize(EnumSize.LARGE);
        BlueSteelIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","BlueSteelIngot2x",16053), EnumMetalType.BLUESTEEL).setItemName("BlueSteelIngot2x").setIconCoord(4, 5)).setSize(EnumSize.LARGE);
        BrassIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","BrassIngot2x",16054), EnumMetalType.BRASS).setItemName("BrassIngot2x").setIconCoord(5, 5)).setSize(EnumSize.LARGE);
        BronzeIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","BronzeIngot2x",16055), EnumMetalType.BRONZE).setItemName("BronzeIngot2x").setIconCoord(6, 5)).setSize(EnumSize.LARGE);
        CopperIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","CopperIngot2x",16056), EnumMetalType.COPPER).setItemName("CopperIngot2x").setIconCoord(7, 5)).setSize(EnumSize.LARGE);
        GoldIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","GoldIngot2x",16057), EnumMetalType.GOLD).setItemName("GoldIngot2x").setIconCoord(8, 5)).setSize(EnumSize.LARGE);
        WroughtIronIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","WroughtIronIngot2x",16058), EnumMetalType.WROUGHTIRON).setItemName("WroughtIronIngot2x").setIconCoord(9, 5)).setSize(EnumSize.LARGE);
        LeadIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","LeadIngot2x",16059), EnumMetalType.LEAD).setItemName("LeadIngot2x").setIconCoord(10, 5)).setSize(EnumSize.LARGE);
        NickelIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","NickelIngot2x",16060), EnumMetalType.NICKEL).setItemName("NickelIngot2x").setIconCoord(0, 6)).setSize(EnumSize.LARGE);
        PigIronIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","PigIronIngot2x",16061), EnumMetalType.PIGIRON).setItemName("PigIronIngot2x").setIconCoord(1, 6)).setSize(EnumSize.LARGE);
        PlatinumIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","PlatinumIngot2x",16062), EnumMetalType.PLATINUM).setItemName("PlatinumIngot2x").setIconCoord(2, 6)).setSize(EnumSize.LARGE);
        RedSteelIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","RedSteelIngot2x",16063), EnumMetalType.REDSTEEL).setItemName("RedSteelIngot2x").setIconCoord(3, 6)).setSize(EnumSize.LARGE);
        RoseGoldIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","RoseGoldIngot2x",16064), EnumMetalType.ROSEGOLD).setItemName("RoseGoldIngot2x").setIconCoord(4, 6)).setSize(EnumSize.LARGE);
        SilverIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","SilverIngot2x",16065), EnumMetalType.SILVER).setItemName("SilverIngot2x").setIconCoord(5, 6)).setSize(EnumSize.LARGE);
        SteelIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","SteelIngot2x",16066), EnumMetalType.STEEL).setItemName("SteelIngot2x").setIconCoord(6, 6)).setSize(EnumSize.LARGE);
        SterlingSilverIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","SterlingSilverIngot2x",16067), EnumMetalType.STERLINGSILVER).setItemName("SterlingSilverIngot2x").setIconCoord(7, 6)).setSize(EnumSize.LARGE);
        TinIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","TinIngot2x",16068), EnumMetalType.TIN).setItemName("TinIngot2x").setIconCoord(8, 6)).setSize(EnumSize.LARGE);
        ZincIngot2x  = ((ItemIngot)new ItemIngot(TFC_Settings.getIntFor(config,"item","ZincIngot2x",16069), EnumMetalType.ZINC).setItemName("ZincIngot2x").setIconCoord(9, 6)).setSize(EnumSize.LARGE);
        ...
        HCBlackSteelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","HCBlackSteelIngot",16290), EnumMetalType.BLACKSTEEL).setItemName("HCBlackSteelIngot").setIconCoord(3, 3);
        WeakBlueSteelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","WeakBlueSteelIngot",16291),EnumMetalType.BLUESTEEL).setItemName("WeakBlueSteelIngot").setIconCoord(4, 3);
        WeakRedSteelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","WeakRedSteelIngot",16292),EnumMetalType.REDSTEEL).setItemName("WeakRedSteelIngot").setIconCoord(3, 4);
        WeakSteelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","WeakSteelIngot",16293),EnumMetalType.STEEL).setItemName("WeakSteelIngot").setIconCoord(6, 4);
        HCBlueSteelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","HCBlueSteelIngot",16294), EnumMetalType.BLUESTEEL).setItemName("HCBlueSteelIngot").setIconCoord(4, 3);
        HCRedSteelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","HCRedSteelIngot",16295), EnumMetalType.REDSTEEL).setItemName("HCRedSteelIngot").setIconCoord(3, 4);
        HCSteelIngot = new ItemIngot(TFC_Settings.getIntFor(config,"item","HCSteelIngot",16296), EnumMetalType.STEEL).setItemName("HCSteelIngot").setIconCoord(6, 4);
