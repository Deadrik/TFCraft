    ...
    public void updateTask()
    {
        ...
        if (this.eatGrassTick == 4)
        {
            ...
            else if (this.theWorld.getBlockId(var1, var2 - 1, var3) == TFCBlocks.Grass.blockID)
            {
                ...
                this.theWorld.setBlockAndMetadataWithNotify(var1, var2 - 1, var3, TFCBlocks.Dirt.blockID, meta,2);
                this.theEntity.eatGrassBonus();
            }
            else if (this.theWorld.getBlockId(var1, var2 - 1, var3) == TFCBlocks.Grass2.blockID)
            {
                ...
                this.theWorld.setBlockAndMetadataWithNotify(var1, var2 - 1, var3, TFCBlocks.Dirt2.blockID, meta,2);
                this.theEntity.eatGrassBonus();
            }
