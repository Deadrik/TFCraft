...
import TFC.Items.Tools.ItemFishingRod;
...
public class EntityFishHookTFC extends EntityFishHook
{
	...
	public int catchFish()
	{
		...
		else
		{
			...
			{
				EntityItem entityitem = new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, ItemFoodTFC.createTag(new ItemStack(Item.fishRaw), Helper.roundNumber(10+rand.nextFloat()*30, 10)));
