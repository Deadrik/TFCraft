...
public class EntityDeer extends EntityAnimal implements IAnimal
{
	...
	{
		/*
		 * if(pregnant){ if(TFC_Time.getTotalTicks() >= conception +
		 * pregnancyTime * TFC_Settings.dayLength){ EntityDeer baby = new
		 * EntityDeer(worldObj, this,mateSizeMod); giveBirth(baby); pregnant =
		 * false; } }
		 */
	...
	/*
	 * @Override public EntityAgeable createChild(EntityAgeable entityageable) {
	 * return new EntityDeer(worldObj, this,
	 * entityageable.getEntityData().getInteger("Size Modifier")); }
	 */
