...
import TFC.Blocks.BlockCustomBookshelf;
import TFC.Blocks.BlockCustomCactus;
import TFC.Blocks.BlockCustomDoor;
import TFC.Blocks.BlockCustomFenceGate;
import TFC.Blocks.BlockCustomFlower;
import TFC.Blocks.BlockCustomFlowing;
...
import TFC.Blocks.BlockCustomStationary;
import TFC.Blocks.BlockCustomTallGrass;
import TFC.Blocks.BlockCustomVine;
import TFC.Blocks.BlockCustomWall;
...
import TFC.Blocks.BlockIgEx;
import TFC.Blocks.BlockIgExBrick;
import TFC.Blocks.BlockIgExCobble;
import TFC.Blocks.BlockIgExSmooth;
import TFC.Blocks.BlockIgIn;
import TFC.Blocks.BlockIgInBrick;
import TFC.Blocks.BlockIgInCobble;
import TFC.Blocks.BlockIgInSmooth;
...
import TFC.Blocks.BlockMM;
import TFC.Blocks.BlockMMBrick;
import TFC.Blocks.BlockMMCobble;
import TFC.Blocks.BlockMMSmooth;
...
import TFC.Blocks.BlockSand2;
import TFC.Blocks.BlockScribe;
import TFC.Blocks.BlockSed;
import TFC.Blocks.BlockSedBrick;
import TFC.Blocks.BlockSedCobble;
import TFC.Blocks.BlockSedSmooth;
...
public class TFCBlocks 
{
	...
	public static TFC.Blocks.BlockGrass Grass;
	...
	public static void LoadBlocks()
	{
		...
		Block.blocksList[39] = (new BlockCustomMushroom(39)).setHardness(0.0F).setStepSound(Block.soundGrassFootstep).setLightValue(0.125F).setUnlocalizedName("mushroom");
		Block.blocksList[40] = (new BlockCustomMushroom(40)).setHardness(0.0F).setStepSound(Block.soundGrassFootstep).setUnlocalizedName("mushroom");
