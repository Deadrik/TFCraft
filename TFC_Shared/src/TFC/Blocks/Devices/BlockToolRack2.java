...
public class BlockToolRack2 extends BlockTerraContainer implements IMultipleBlock
{
	String[] woodNames;
	public BlockToolRack2(int par1)
	{
	...
	public boolean removeBlockByPlayer(World world, EntityPlayer player, int x, int y, int z)
	{
		if(!world.isRemote)
		{
			...
			if((te != null) && (te instanceof TileEntityToolRack))
			{
				...
				dropBlockAsItem_do(world, x, y, z, new ItemStack(TFCBlocks.ToolRack2, 1, rack.woodType));
			}
		}
	...
	{
		return getIcon(0,((TileEntityToolRack)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).woodType);
	...
	{
		return getBlockTypeForRender().getIcon(par1, Math.min(par2,woodNames.length-1));
	}
