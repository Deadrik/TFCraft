...
public abstract class BlockCustomFluid extends Block
{
    ...
    {
        Material var6 = par1IBlockAccess.getBlockMaterial(par2, par3, par4);
        return var6 == this.blockMaterial ? false : (par5 == 1 ? true : (var6 == Material.ice ? false : true));
    }
    ...
    public static double func_293_a(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, Material par4Material)
    {
        ...
        {
            var5 = ((BlockCustomFluid)Block.waterMoving).getFlowVector(par0IBlockAccess, par1, par2, par3);
        }

        if (par4Material == Material.lava)
        {
            var5 = ((BlockCustomFluid)Block.lavaMoving).getFlowVector(par0IBlockAccess, par1, par2, par3);
        }
