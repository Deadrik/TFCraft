...
public class BlockCustomCrops extends BlockCustomFlower
{
	public BlockCustomCrops(int par1, int par2)
	{
		super(par1, par2);
	...
	{
		boolean b = par1 == TFCBlocks.tilledSoil.blockID || par1 == TFCBlocks.tilledSoil2.blockID;
		return b;
	}
	 ...
	 private float getGrowthRate(World par1World, int par2, int par3, int par4)
	 {
		 ...
		 for (int var17 = par2 - 1; var17 <= par2 + 1; ++var17)
		 {
			 for (int var18 = par4 - 1; var18 <= par4 + 1; ++var18)
			 {
				 ...
				 if (var19 == TFCBlocks.tilledSoil.blockID || var19 == TFCBlocks.tilledSoil2.blockID)
				 {
					 var20 = 1.0F;

					 if (BlockTerraFarmland.isWaterNearby(par1World, par2, par3-1, par4))
					 {
						 var20 = 3.0F;
					 }
				 }
