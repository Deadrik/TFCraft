...
public class Recipes 
{
	...
	public static void registerAnvilRecipes(Random R, World world)
	{
		...
		for(int i = 0; i < 5; i++)
		{
			...
			manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.BismuthBronzeIngot), new ItemStack(TFCItems.HoeHeadPlan),20 + R.nextInt(55),CraftingRuleEnum.PUNCHLAST, CraftingRuleEnum.HITLASTTWO, CraftingRuleEnum.BENDLASTTWO, false, AnvilReq.BISMUTHBRONZE, new ItemStack(TFCItems.BismuthBronzeHoeHead, 1, dam)));
			manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.BlackBronzeIngot), new ItemStack(TFCItems.HoeHeadPlan),20 + R.nextInt(55),CraftingRuleEnum.PUNCHLAST, CraftingRuleEnum.HITLASTTWO, CraftingRuleEnum.BENDLASTTWO, false, AnvilReq.BLACKBRONZE, new ItemStack(TFCItems.BlackBronzeHoeHead, 1, dam)));
			manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.BlackSteelIngot), new ItemStack(TFCItems.HoeHeadPlan),20 + R.nextInt(55),CraftingRuleEnum.PUNCHLAST, CraftingRuleEnum.HITLASTTWO, CraftingRuleEnum.BENDLASTTWO, false, AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.BlackSteelHoeHead, 1, dam)));
			manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.BlueSteelIngot), new ItemStack(TFCItems.HoeHeadPlan),20 + R.nextInt(55),CraftingRuleEnum.PUNCHLAST, CraftingRuleEnum.HITLASTTWO, CraftingRuleEnum.BENDLASTTWO, false, AnvilReq.BLUESTEEL, new ItemStack(TFCItems.BlueSteelHoeHead, 1, dam)));
			manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.BronzeIngot), new ItemStack(TFCItems.HoeHeadPlan),20 + R.nextInt(55),CraftingRuleEnum.PUNCHLAST, CraftingRuleEnum.HITLASTTWO, CraftingRuleEnum.BENDLASTTWO, false, AnvilReq.BRONZE, new ItemStack(TFCItems.BronzeHoeHead, 1, dam)));
			manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.CopperIngot), new ItemStack(TFCItems.HoeHeadPlan),20 + R.nextInt(55),CraftingRuleEnum.PUNCHLAST, CraftingRuleEnum.HITLASTTWO, CraftingRuleEnum.BENDLASTTWO, false, AnvilReq.COPPER, new ItemStack(TFCItems.CopperHoeHead, 1, dam)));
			manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.WroughtIronIngot), new ItemStack(TFCItems.HoeHeadPlan),20 + R.nextInt(55),CraftingRuleEnum.PUNCHLAST, CraftingRuleEnum.HITLASTTWO, CraftingRuleEnum.BENDLASTTWO, false, AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.WroughtIronHoeHead, 1, dam)));
			manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.RedSteelIngot), new ItemStack(TFCItems.HoeHeadPlan),20 + R.nextInt(55),CraftingRuleEnum.PUNCHLAST, CraftingRuleEnum.HITLASTTWO, CraftingRuleEnum.BENDLASTTWO, false, AnvilReq.REDSTEEL, new ItemStack(TFCItems.RedSteelHoeHead, 1, dam)));
			...
			manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.SteelIngot), new ItemStack(TFCItems.HoeHeadPlan),20 + R.nextInt(55),CraftingRuleEnum.PUNCHLAST, CraftingRuleEnum.HITLASTTWO, CraftingRuleEnum.BENDLASTTWO, false, AnvilReq.STEEL, new ItemStack(TFCItems.SteelHoeHead, 1, dam)));
