...
public class mod_TFC implements ITickHandler
{
	...
	public void load(FMLInitializationEvent evt)
	{
		...
		//		sulfurRenderId = RenderingRegistry..getUniqueBlockModelID(this, false);
	...
	static
	{
		try
		{
			config = new Configuration(new File(mod_TFC.proxy.getMinecraftDir(), "/config/TFC.cfg"));
			config.load();
		} catch (Exception e) {
