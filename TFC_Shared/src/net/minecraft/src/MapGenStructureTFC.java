...
import net.minecraft.src.TFC_Core.Custom.StructureComponentTFC;
import net.minecraft.src.TFC_Core.Custom.StructureStartTFC;

public abstract class MapGenStructureTFC extends MapGenBase
{
    ...
    protected void recursiveGenerate(World par1World, int par2, int par3, int par4, int par5, byte[] par6ArrayOfByte)
    {
        if (!this.coordMap.containsKey(Long.valueOf(ChunkCoordIntPair.chunkXZ2Int(par2, par3))))
        {
            ...
            {
                StructureStartTFC var7 = this.getStructureStart(par2, par3);
    ...
    public boolean generateStructuresInChunk(World par1World, Random par2Random, int par3, int par4)
    {
        ...
        while (var8.hasNext())
        {
            StructureStartTFC var9 = (StructureStartTFC)var8.next();
    ...
    public boolean func_40483_a(int par1, int par2, int par3)
    {
        ...
        while (var4.hasNext())
        {
            StructureStartTFC var5 = (StructureStartTFC)var4.next();
            ...
            if (var5.isSizeableStructure() && var5.getBoundingBox().intersectsWith(par1, par3, par1, par3))
            {
                ...
                while (var6.hasNext())
                {
                    StructureComponentTFC var7 = (StructureComponentTFC)var6.next();
    ...
    public ChunkPosition getNearestInstance(World par1World, int par2, int par3, int par4)
    {
        ...
        while (var16.hasNext())
        {
            StructureStartTFC var17 = (StructureStartTFC)var16.next();

            if (var17.isSizeableStructure())
            {
                StructureComponentTFC var18 = (StructureComponentTFC)var17.getComponents().get(0);
    ...
    protected abstract StructureStartTFC getStructureStart(int var1, int var2);
}
