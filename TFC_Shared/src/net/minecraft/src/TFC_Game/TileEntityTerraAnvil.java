...
public class TileEntityTerraAnvil extends TileEntity implements IInventory
{
	...
	private int itemCraftingValue;
	public int[] itemCraftingRules;
	private int craftingValue;
	private int craftingRange;
	private int craftingReq;
	...
	public void actionWeld()
	{
		if(isTemperatureWeldable(2) && isTemperatureWeldable(3) && anvilItemStacks[0] != null && 
				anvilItemStacks[2].getItemDamage() == 0 && anvilItemStacks[3].getItemDamage() == 0 && getAnvilType() >= craftingReq && anvilItemStacks[7] != null)
		{
