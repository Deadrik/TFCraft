...
public class TFC_Game 
{
    ...
    public static void registerAnvilRecipes(Random R, World world)
    {
        ...
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthIngot2x), null, 20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.BismuthSheet)));
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthBronzeIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.BISMUTHBRONZE, new ItemStack(mod_TFC_Game.BismuthBronzeSheet)));
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackBronzeIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.BLACKBRONZE, new ItemStack(mod_TFC_Game.BlackBronzeSheet)));
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackSteelIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.BLACKSTEEL, new ItemStack(mod_TFC_Game.BlackSteelSheet)));
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlueSteelIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.BLUESTEEL, new ItemStack(mod_TFC_Game.BlueSteelSheet)));
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBronzeIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.BronzeSheet)));
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraCopperIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.COPPER, new ItemStack(mod_TFC_Game.CopperSheet)));
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraWroughtIronIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.WROUGHTIRON, new ItemStack(mod_TFC_Game.WroughtIronSheet)));
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRedSteelIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.REDSTEEL, new ItemStack(mod_TFC_Game.RedSteelSheet)));
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRoseGoldIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.RoseGoldSheet)));       
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraSteelIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.STEEL, new ItemStack(mod_TFC_Game.SteelSheet)));
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraTinIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.TinSheet)));
        manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraZincIngot2x), null,20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.HITTHIRDFROMLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.ZincSheet)));
        ...
        for(int i = 0; i < 5; i++)
        {
            ...
            int dam = i * 5;
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan), 20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.BismuthPickaxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthBronzeIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.BISMUTHBRONZE, new ItemStack(mod_TFC_Game.BismuthBronzePickaxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackBronzeIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.BLACKBRONZE, new ItemStack(mod_TFC_Game.BlackBronzePickaxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackSteelIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.BLACKSTEEL, new ItemStack(mod_TFC_Game.BlackSteelPickaxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlueSteelIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.BLUESTEEL, new ItemStack(mod_TFC_Game.BlueSteelPickaxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBronzeIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.BronzePickaxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraCopperIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.COPPER, new ItemStack(mod_TFC_Game.CopperPickaxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraWroughtIronIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.WROUGHTIRON, new ItemStack(mod_TFC_Game.WroughtIronPickaxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRedSteelIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.REDSTEEL, new ItemStack(mod_TFC_Game.RedSteelPickaxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRoseGoldIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.RoseGoldPickaxeHead, 1, dam)));       
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraSteelIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.STEEL, new ItemStack(mod_TFC_Game.SteelPickaxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraTinIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.TinPickaxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraZincIngot), new ItemStack(mod_TFC_Game.PickaxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.BENDNOTLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.ZincPickaxeHead, 1, dam)));
        }
        //shovels
        for(int i = 0; i < 5; i++)
        {
            ...
            int dam = i * 5;
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.BismuthShovelHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthBronzeIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.BISMUTHBRONZE, new ItemStack(mod_TFC_Game.BismuthBronzeShovelHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackBronzeIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.BLACKBRONZE, new ItemStack(mod_TFC_Game.BlackBronzeShovelHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackSteelIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.BLACKSTEEL, new ItemStack(mod_TFC_Game.BlackSteelShovelHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlueSteelIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.BLUESTEEL, new ItemStack(mod_TFC_Game.BlueSteelShovelHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBronzeIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.BronzeShovelHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraCopperIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.COPPER, new ItemStack(mod_TFC_Game.CopperShovelHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraWroughtIronIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.WROUGHTIRON, new ItemStack(mod_TFC_Game.WroughtIronShovelHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRedSteelIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.REDSTEEL, new ItemStack(mod_TFC_Game.RedSteelShovelHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRoseGoldIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.RoseGoldShovelHead, 1, dam)));       
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraSteelIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.STEEL, new ItemStack(mod_TFC_Game.SteelShovelHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraTinIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.TinShovelHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraZincIngot), new ItemStack(mod_TFC_Game.ShovelHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.HITLASTTHREE, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.ZincShovelHead, 1, dam)));
        }
        //axes 
        for(int i = 0; i < 5; i++)
        {
            ...
            int dam = i * 5;
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.BismuthAxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthBronzeIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.BISMUTHBRONZE, new ItemStack(mod_TFC_Game.BismuthBronzeAxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackBronzeIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.BLACKBRONZE, new ItemStack(mod_TFC_Game.BlackBronzeAxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackSteelIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.BLACKSTEEL, new ItemStack(mod_TFC_Game.BlackSteelAxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlueSteelIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.BLUESTEEL, new ItemStack(mod_TFC_Game.BlueSteelAxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBronzeIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.BronzeAxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraCopperIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.COPPER, new ItemStack(mod_TFC_Game.CopperAxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraWroughtIronIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.WROUGHTIRON, new ItemStack(mod_TFC_Game.WroughtIronAxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRedSteelIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.REDSTEEL, new ItemStack(mod_TFC_Game.RedSteelAxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRoseGoldIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.RoseGoldAxeHead, 1, dam)));       
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraSteelIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.STEEL, new ItemStack(mod_TFC_Game.SteelAxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraTinIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.TinAxeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraZincIngot), new ItemStack(mod_TFC_Game.AxeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.UPSETTHIRDFROMLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.ZincAxeHead, 1, dam)));
        }
        //hoes
        for(int i = 0; i < 5; i++)
        {
            ...
            int dam = i * 5;
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.BismuthHoeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthBronzeIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.BISMUTHBRONZE, new ItemStack(mod_TFC_Game.BismuthBronzeHoeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackBronzeIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.BLACKBRONZE, new ItemStack(mod_TFC_Game.BlackBronzeHoeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackSteelIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.BLACKSTEEL, new ItemStack(mod_TFC_Game.BlackSteelHoeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlueSteelIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.BLUESTEEL, new ItemStack(mod_TFC_Game.BlueSteelHoeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBronzeIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.BronzeHoeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraCopperIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.COPPER, new ItemStack(mod_TFC_Game.CopperHoeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraWroughtIronIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.WROUGHTIRON, new ItemStack(mod_TFC_Game.WroughtIronHoeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRedSteelIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.REDSTEEL, new ItemStack(mod_TFC_Game.RedSteelHoeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRoseGoldIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.ROSEGOLD, new ItemStack(mod_TFC_Game.RoseGoldHoeHead, 1, dam)));       
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraSteelIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.STEEL, new ItemStack(mod_TFC_Game.SteelHoeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraTinIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.TinHoeHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraZincIngot), new ItemStack(mod_TFC_Game.HoeHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.HITLASTTHREE, CraftingRule.BENDLASTTHREE, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.ZincHoeHead, 1, dam)));
        }
        //Hammers
        for(int i = 0; i < 5; i++)
        {
            ...
            int dam = i * 5;
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.BismuthHammerHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthBronzeIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.BISMUTHBRONZE, new ItemStack(mod_TFC_Game.BismuthBronzeHammerHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackBronzeIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.BLACKBRONZE, new ItemStack(mod_TFC_Game.BlackBronzeHammerHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackSteelIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.BLACKSTEEL, new ItemStack(mod_TFC_Game.BlackSteelHammerHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlueSteelIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.BLUESTEEL, new ItemStack(mod_TFC_Game.BlueSteelHammerHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBronzeIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.BronzeHammerHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraCopperIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.COPPER, new ItemStack(mod_TFC_Game.CopperHammerHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraWroughtIronIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.WROUGHTIRON, new ItemStack(mod_TFC_Game.WroughtIronHammerHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRedSteelIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.REDSTEEL, new ItemStack(mod_TFC_Game.RedSteelHammerHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRoseGoldIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.ROSEGOLD, new ItemStack(mod_TFC_Game.RoseGoldHammerHead, 1, dam)));       
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraSteelIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.STEEL, new ItemStack(mod_TFC_Game.SteelHammerHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraTinIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.TinHammerHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraZincIngot), new ItemStack(mod_TFC_Game.HammerHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.ANY, CraftingRule.SHRINKNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.ZincHammerHead, 1, dam)));
        }
        //Chisels     
        for(int i = 0; i < 5; i++)
        {
            ...
            int dam = i * 5;
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.BismuthChiselHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthBronzeIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.BISMUTHBRONZE, new ItemStack(mod_TFC_Game.BismuthBronzeChiselHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackBronzeIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.BLACKBRONZE, new ItemStack(mod_TFC_Game.BlackBronzeChiselHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackSteelIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.BLACKSTEEL, new ItemStack(mod_TFC_Game.BlackSteelChiselHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlueSteelIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.BLUESTEEL, new ItemStack(mod_TFC_Game.BlueSteelChiselHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBronzeIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.BronzeChiselHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraCopperIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.COPPER, new ItemStack(mod_TFC_Game.CopperChiselHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraWroughtIronIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.WROUGHTIRON, new ItemStack(mod_TFC_Game.WroughtIronChiselHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRedSteelIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.REDSTEEL, new ItemStack(mod_TFC_Game.RedSteelChiselHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRoseGoldIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.ROSEGOLD, new ItemStack(mod_TFC_Game.RoseGoldChiselHead, 1, dam)));       
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraSteelIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.STEEL, new ItemStack(mod_TFC_Game.SteelChiselHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraTinIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.TinChiselHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraZincIngot), new ItemStack(mod_TFC_Game.ChiselHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.DRAWNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.ZincChiselHead, 1, dam)));
        }
        //ProPicks
        for(int i = 0; i < 5; i++)
        {
            ...
            int dam = i * 5;
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.BismuthProPickHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthBronzeIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.BISMUTHBRONZE, new ItemStack(mod_TFC_Game.BismuthBronzeProPickHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackBronzeIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.BLACKBRONZE, new ItemStack(mod_TFC_Game.BlackBronzeProPickHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackSteelIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.BLACKSTEEL, new ItemStack(mod_TFC_Game.BlackSteelProPickHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlueSteelIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.BLUESTEEL, new ItemStack(mod_TFC_Game.BlueSteelProPickHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBronzeIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.BronzeProPickHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraCopperIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.COPPER, new ItemStack(mod_TFC_Game.CopperProPickHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraWroughtIronIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.WROUGHTIRON, new ItemStack(mod_TFC_Game.WroughtIronProPickHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRedSteelIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.REDSTEEL, new ItemStack(mod_TFC_Game.RedSteelProPickHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRoseGoldIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.ROSEGOLD, new ItemStack(mod_TFC_Game.RoseGoldProPickHead, 1, dam)));       
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraSteelIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.STEEL, new ItemStack(mod_TFC_Game.SteelProPickHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraTinIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.TinProPickHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraZincIngot), new ItemStack(mod_TFC_Game.ProPickHeadPlan),20 + R.nextInt(55),CraftingRule.PUNCHLAST, CraftingRule.DRAWNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.ZincProPickHead, 1, dam)));
        }
        //Saws
        for(int i = 0; i < 5; i++)
        {
            ...
            int dam = i * 5;
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.BismuthSawHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthBronzeIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.BISMUTHBRONZE, new ItemStack(mod_TFC_Game.BismuthBronzeSawHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackBronzeIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.BLACKBRONZE, new ItemStack(mod_TFC_Game.BlackBronzeSawHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackSteelIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.BLACKSTEEL, new ItemStack(mod_TFC_Game.BlackSteelSawHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlueSteelIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.BLUESTEEL, new ItemStack(mod_TFC_Game.BlueSteelSawHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBronzeIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.BronzeSawHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraCopperIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.COPPER, new ItemStack(mod_TFC_Game.CopperSawHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraWroughtIronIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.WROUGHTIRON, new ItemStack(mod_TFC_Game.WroughtIronSawHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRedSteelIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.REDSTEEL, new ItemStack(mod_TFC_Game.RedSteelSawHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRoseGoldIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.ROSEGOLD, new ItemStack(mod_TFC_Game.RoseGoldSawHead, 1, dam)));       
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraSteelIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.STEEL, new ItemStack(mod_TFC_Game.SteelSawHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraTinIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.TinSawHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraZincIngot), new ItemStack(mod_TFC_Game.SawBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.HITSECONDFROMLAST, CraftingRule.ANY, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.ZincSawHead, 1, dam)));
        }
        //Swords
        ...
        {
            int dam = i * 5;
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.BismuthSwordHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthBronzeIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.BISMUTHBRONZE, new ItemStack(mod_TFC_Game.BismuthBronzeSwordHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackBronzeIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.BLACKBRONZE, new ItemStack(mod_TFC_Game.BlackBronzeSwordHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackSteelIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.BLACKSTEEL, new ItemStack(mod_TFC_Game.BlackSteelSwordHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlueSteelIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.BLUESTEEL, new ItemStack(mod_TFC_Game.BlueSteelSwordHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBronzeIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.BronzeSwordHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraCopperIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.COPPER, new ItemStack(mod_TFC_Game.CopperSwordHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraWroughtIronIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.WROUGHTIRON, new ItemStack(mod_TFC_Game.WroughtIronSwordHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRedSteelIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.REDSTEEL, new ItemStack(mod_TFC_Game.RedSteelSwordHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRoseGoldIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.ROSEGOLD, new ItemStack(mod_TFC_Game.RoseGoldSwordHead, 1, dam)));       
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraSteelIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.STEEL, new ItemStack(mod_TFC_Game.SteelSwordHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraTinIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.TinSwordHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraZincIngot2x), new ItemStack(mod_TFC_Game.SwordBladePlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.BENDSECONDFROMLAST, CraftingRule.BENDTHIRDFROMLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.ZincSwordHead, 1, dam)));
        }
        //Maces
        ...
        for(int i = 0; i < 5; i++)
        {
            ...
            int dam = i * 5;
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.BismuthMaceHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBismuthBronzeIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.BISMUTHBRONZE, new ItemStack(mod_TFC_Game.BismuthBronzeMaceHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackBronzeIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.BLACKBRONZE, new ItemStack(mod_TFC_Game.BlackBronzeMaceHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlackSteelIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.BLACKSTEEL, new ItemStack(mod_TFC_Game.BlackSteelMaceHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBlueSteelIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.BLUESTEEL, new ItemStack(mod_TFC_Game.BlueSteelMaceHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraBronzeIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.BRONZE, new ItemStack(mod_TFC_Game.BronzeMaceHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraCopperIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.COPPER, new ItemStack(mod_TFC_Game.CopperMaceHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraWroughtIronIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.WROUGHTIRON, new ItemStack(mod_TFC_Game.WroughtIronMaceHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRedSteelIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.REDSTEEL, new ItemStack(mod_TFC_Game.RedSteelMaceHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraRoseGoldIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.ROSEGOLD, new ItemStack(mod_TFC_Game.RoseGoldMaceHead, 1, dam)));      
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraSteelIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.STEEL, new ItemStack(mod_TFC_Game.SteelMaceHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraTinIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.TinMaceHead, 1, dam)));
            manager.addRecipe(new AnvilRecipe(new ItemStack(mod_TFC_Core.terraZincIngot2x), new ItemStack(mod_TFC_Game.MaceHeadPlan),20 + R.nextInt(55),CraftingRule.HITLAST, CraftingRule.SHRINKNOTLAST, CraftingRule.BENDNOTLAST, false, AnvilReq.STONE, new ItemStack(mod_TFC_Game.ZincMaceHead, 1, dam)));
        }
