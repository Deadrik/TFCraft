...
public class TFCItems
{
    ...
    public static void Setup()
    {
        ...
        WheatGrain = new ItemTerraFood(TFCSettings.getIntFor(config,"item","WheatGrain",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(1, 4).setItemName("WheatGrain");
        WildWheatGrain = new ItemTerraFood(TFCSettings.getIntFor(config,"item","WildWheatGrain",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(1, 4).setItemName("WildWheatGrain");
        BarleyGrain = new ItemTerraFood(TFCSettings.getIntFor(config,"item","BarleyGrain",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(0, 4).setItemName("BarleyGrain");
        WildBarleyGrain = new ItemTerraFood(TFCSettings.getIntFor(config,"item","WildBarleyGrain",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(0, 4).setItemName("WildBarleyGrain");
        OatGrain = new ItemTerraFood(TFCSettings.getIntFor(config,"item","OatGrain",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(3, 4).setItemName("OatGrain");
        WildOatGrain = new ItemTerraFood(TFCSettings.getIntFor(config,"item","WildOatGrain",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(3, 4).setItemName("WildOatGrain");
        RyeGrain = new ItemTerraFood(TFCSettings.getIntFor(config,"item","RyeGrain",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(2, 4).setItemName("RyeGrain");
        WildRyeGrain = new ItemTerraFood(TFCSettings.getIntFor(config,"item","WildRyeGrain",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(2, 4).setItemName("WildRyeGrain");
        RiceGrain = new ItemTerraFood(TFCSettings.getIntFor(config,"item","RiceGrain",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(4, 4).setItemName("RiceGrain");
        WildRiceGrain = new ItemTerraFood(TFCSettings.getIntFor(config,"item","WildRiceGrain",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(4, 4).setItemName("WildRiceGrain");
        MaizeEar = new ItemTerraFood(TFCSettings.getIntFor(config,"item","MaizeEar",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(5, 4).setItemName("MaizeEar");
        WildMaizeEar = new ItemTerraFood(TFCSettings.getIntFor(config,"item","WildMaizeEar",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(5, 4).setItemName("WildMaizeEar");
        Tomato = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Tomato",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(15, 4).setItemName("Tomato");
        Potato = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Potato",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(6, 4).setItemName("Potato");
        WildPotato = new ItemTerraFood(TFCSettings.getIntFor(config,"item","WildPotato",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(6, 4).setItemName("WildPotato");
        Onion = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Onion",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(7, 4).setItemName("Onion");
        Cabbage = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Cabbage",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(8, 4).setItemName("Cabbage");
        Garlic = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Garlic",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(11, 4).setItemName("Garlic");
        Carrot = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Carrot",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(12, 4).setItemName("Carrot");
        Sugarcane = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Sugarcane",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(13, 4).setItemName("Sugarcane");
        Hemp = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Hemp",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(15, 2).setItemName("Hemp");
        Soybeans = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Soybeans",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(0, 7).setItemName("Soybeans");
        Greenbeans = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Greenbeans",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(0, 7).setItemName("Greenbeans");
        Yam = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Yam",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(0, 7).setItemName("Yam");
        GreenBellPepper = new ItemTerraFood(TFCSettings.getIntFor(config,"item","GreenBellPepper",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(0, 7).setItemName("GreenBellPepper");
        YellowBellPepper = new ItemTerraFood(TFCSettings.getIntFor(config,"item","YellowBellPepper",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(0, 7).setItemName("YellowBellPepper");
        RedBellPepper = new ItemTerraFood(TFCSettings.getIntFor(config,"item","RedBellPepper",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(0, 7).setItemName("RedBellPepper");
        Squash = new ItemTerraFood(TFCSettings.getIntFor(config,"item","Squash",num++), 4, 0.4F, false,"/bioxx/FoodSprites.png").setIconCoord(0, 7).setItemName("Squash");
        
        WheatWhole = new ItemTerra(TFCSettings.getIntFor(config,"item","WheatWhole",num++),"/bioxx/FoodSprites.png").setItemName("WheatWhole").setIconCoord(1, 5);
        WildWheatWhole = new ItemTerra(TFCSettings.getIntFor(config,"item","WildWheatWhole",num++),"/bioxx/FoodSprites.png").setItemName("WildWheatWhole").setIconCoord(1, 5);
        BarleyWhole = new ItemTerra(TFCSettings.getIntFor(config,"item","BarleyWhole",num++),"/bioxx/FoodSprites.png").setItemName("BarleyWhole").setIconCoord(0, 5);
        WildBarleyWhole = new ItemTerra(TFCSettings.getIntFor(config,"item","WildBarleyWhole",num++),"/bioxx/FoodSprites.png").setItemName("WildBarleyWhole").setIconCoord(0, 5);
        OatWhole = new ItemTerra(TFCSettings.getIntFor(config,"item","OatWhole",num++),"/bioxx/FoodSprites.png").setItemName("OatWhole").setIconCoord(3, 5);
        WildOatWhole = new ItemTerra(TFCSettings.getIntFor(config,"item","WildOatWhole",num++),"/bioxx/FoodSprites.png").setItemName("WildOatWhole").setIconCoord(3, 5);
        RyeWhole = new ItemTerra(TFCSettings.getIntFor(config,"item","RyeWhole",num++),"/bioxx/FoodSprites.png").setItemName("RyeWhole").setIconCoord(2, 5);
        WildRyeWhole = new ItemTerra(TFCSettings.getIntFor(config,"item","WildRyeWhole",num++),"/bioxx/FoodSprites.png").setItemName("WildRyeWhole").setIconCoord(2, 5);
        RiceWhole = new ItemTerra(TFCSettings.getIntFor(config,"item","RiceWhole",num++),"/bioxx/FoodSprites.png").setItemName("RiceWhole").setIconCoord(4, 5);
        WildRiceWhole = new ItemTerra(TFCSettings.getIntFor(config,"item","WildRiceWhole",num++),"/bioxx/FoodSprites.png").setItemName("WildRiceWhole").setIconCoord(4, 5);
        ...
        SeedsMaize = new ItemCustomSeeds(TFCSettings.getIntFor(config,"item","SeedsMaize",num++),2).setItemName("SeedsMaize").setIconCoord(9, 0);
        SeedsWildMaize = new ItemCustomSeeds(TFCSettings.getIntFor(config,"item","SeedsWildMaize",num++),3).setItemName("SeedsWildMaize").setIconCoord(9, 0);
        ...
        SeedsWildOat = new ItemCustomSeeds(TFCSettings.getIntFor(config,"item","SeedsWildOat",num++),10).setItemName("SeedsWildOat").setIconCoord(9, 0);
