										...
										if (var51 > -0.7D && var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
										{
													...
													var53 == mod_TFC_Core.terraClayGrass.blockID || var53 == mod_TFC_Core.terraClayGrass2.blockID || var53 == mod_TFC_Core.terraPeat.blockID)
											{
												...
												else
												{
													...
													if (var49 && par5ArrayOfByte[var48 - 1] == (byte)mod_TFC_Core.terraDirt.blockID)
													{
														par5ArrayOfByte[var48 - 1] = (byte) this.worldObj.getBiomeGenForCoords(var42 + par3 * 16, var45 + par4 * 16).GrassID;
													}
													if (var49 && par5ArrayOfByte[var48 - 1] == (byte)mod_TFC_Core.terraDirt2.blockID)
													{
														par5ArrayOfByte[var48 - 1] = (byte) this.worldObj.getBiomeGenForCoords(var42 + par3 * 16, var45 + par4 * 16).GrassID;
													}
												}
