...
public class BlockStair extends BlockPartial
{
    ...
    public void getCollidingBoundingBoxes(World par1World, int par2, int par3, int par4, AxisAlignedBB par5AxisAlignedBB, ArrayList par6ArrayList)
    {
        ...
        Block.blocksList[53].getCollidingBoundingBoxes(par1World, par2, par3, par4, par5AxisAlignedBB, par6ArrayList);
    ...
    {
        return Block.blocksList[53].getCollisionBoundingBoxFromPool(par1World, par2, par3, par4);
    }
