        ...
        else
        {
            if(biome instanceof BiomeGenRiverTFC || biome instanceof BiomeGenOceanTFC || biome instanceof BiomeGenSwampTFC)
            {
                if(par1World.getBlockId(par2+1, par3, par4) == 0 || 
                        (par1World.getBlockId(par2+1, par3, par4) == mod_TFC_Core.finiteWater.blockID && par1World.getBlockMetadata(par2+1, par3, par4) != 0))
                {
                    par1World.editingBlocks = true;
                    par1World.setBlockAndMetadata(par2+1, par3, par4, mod_TFC_Core.finiteWater.blockID, 0);
                    par1World.markBlocksDirty(par2+1, par3, par4, par2+1, par3, par4);
                    par1World.scheduleBlockUpdate(par2+1, par3, par4, mod_TFC_Core.finiteWater.blockID, this.tickRate());
                    par1World.editingBlocks = false;
                }
                        ...
                        (par1World.getBlockId(par2-1, par3, par4) == mod_TFC_Core.finiteWater.blockID && par1World.getBlockMetadata(par2-1, par3, par4) != 0))
                {
                    ...
                    par1World.editingBlocks = false;
                        ...
                        (par1World.getBlockId(par2, par3, par4+1) == mod_TFC_Core.finiteWater.blockID && par1World.getBlockMetadata(par2, par3, par4+1) != 0))
                {
                    par1World.editingBlocks = true;
                    par1World.setBlockAndMetadata(par2, par3, par4+1, mod_TFC_Core.finiteWater.blockID, 0);
                    par1World.markBlocksDirty(par2, par3, par4+1, par2, par3, par4+1);
                    par1World.scheduleBlockUpdate(par2, par3, par4+1, mod_TFC_Core.finiteWater.blockID, this.tickRate());
                    par1World.editingBlocks = false;
                }
                else if(par1World.getBlockId(par2, par3, par4-1) == 0 || 
                        (par1World.getBlockId(par2, par3, par4-1) == mod_TFC_Core.finiteWater.blockID && par1World.getBlockMetadata(par2, par3, par4-1) != 0))
                {
                    ...
                    par1World.editingBlocks = false;
                        ...
                        (par1World.getBlockId(par2, par3-1, par4) == mod_TFC_Core.finiteWater.blockID && par1World.getBlockMetadata(par2, par3-1, par4) != 0))
                {
                    par1World.editingBlocks = true;
                    par1World.setBlockAndMetadata(par2, par3-1, par4, mod_TFC_Core.finiteWater.blockID, 0);
                    par1World.markBlocksDirty(par2, par3-1, par4, par2, par3-1, par4);
                    par1World.scheduleBlockUpdate(par2, par3-1, par4, mod_TFC_Core.finiteWater.blockID, this.tickRate());
                    par1World.editingBlocks = false;
                }
            }
            else
            {
                par1World.editingBlocks = true;
                par1World.setBlockAndMetadata(par2, par3, par4, mod_TFC_Core.finiteWater.blockID, 0);
                par1World.markBlocksDirty(par2, par3, par4, par2, par3, par4);
                par1World.scheduleBlockUpdate(par2, par3, par4, mod_TFC_Core.finiteWater.blockID, this.tickRate());
                par1World.editingBlocks = false;
            }
        }
    }
