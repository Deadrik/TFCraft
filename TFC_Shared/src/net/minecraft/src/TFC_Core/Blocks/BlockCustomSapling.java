...
import net.minecraft.src.TFC_Core.Custom.WorldGenCustomCedarTrees;
import net.minecraft.src.TFC_Core.Custom.WorldGenCustomHugeTrees;
import net.minecraft.src.TFC_Core.Custom.WorldGenCustomRedwoodTrees;
import net.minecraft.src.TFC_Core.Custom.WorldGenCustomShortTrees;
import net.minecraft.src.TFC_Core.Custom.WorldGenCustomWillowTrees;
