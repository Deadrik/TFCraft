...
import net.minecraft.src.TFC_Core.Blocks.BlockCollapsable;
    ...
    public void onUpdate()
    {
        ...
        if(pTime == 0)
        {
            ...
            if (onGround)
            {
                ...
                {
                    setDead();
                    if (((!worldObj.canBlockBePlacedAt(blockID, i, j, k, true, 1) && BlockCollapsable.canFallBelow(worldObj, i, j - 1, k)) || 
