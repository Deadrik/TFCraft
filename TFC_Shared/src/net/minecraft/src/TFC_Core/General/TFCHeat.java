...
public class TFCHeat 
{
	...
	static
	{
        ...
        manager.addIndex(new HeatIndex(new ItemStack(TFCItems.TinUnshaped,1), TinRaw,new ItemStack(TFCItems.TinUnshaped,1)).setMorph(new ItemStack(TFCItems.terraCeramicMold,1)));
