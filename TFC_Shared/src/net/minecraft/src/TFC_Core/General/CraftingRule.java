...
public enum CraftingRule
{
    ...
    PUNCHSECONDFROMLAST("Punch Second", 3, 1, 1),
    PUNCHTHIRDFROMLAST("Punch Third", 3, 2, 2),
    ...
    SHRINKSECONDFROMLAST("Shrink Second", 6, 1, 1),
    SHRINKTHIRDFROMLAST("Shrink Third", 6, 2, 2),
    ...
    QUENCHSECONDFROMLAST("Quench Second", 2, 1, 1),
    QUENCHTHIRDFROMLAST("Quench Third", 2, 2, 2),
    ...
    DRAWSECONDFROMLAST("Draw Second", 1, 1, 1),
    DRAWTHIRDFROMLAST("Draw Third", 1, 2, 2),
    ...
    UPSETSECONDFROMLAST("Upset Second", 5, 1, 1),
    UPSETTHIRDFROMLAST("Upset Third", 5, 2, 2),
    UPSETLASTTWO("Upset Last Two", 5, 0, 1),
    UPSETLASTTHREE("Upset Last Three", 5, 0, 2),
    UPSETNOTLAST("Upset Not Last", 5, 1, 2),
    BENDANY("Bend Any", 4, 0, 2),
    BENDLAST("Bend Last", 4, 0, 0),
    BENDSECONDFROMLAST("Bend Second", 4, 1, 1),
    BENDTHIRDFROMLAST("Bend Third", 4, 2, 2),
