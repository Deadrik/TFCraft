...
public abstract class StructureStartTFC
{
    ...
    public void generateStructure(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        while (var4.hasNext())
        {
            StructureComponentTFC var5 = (StructureComponentTFC)var4.next();
    ...
    protected void updateBoundingBox()
    {
        ...
        while (var1.hasNext())
        {
            StructureComponentTFC var2 = (StructureComponentTFC)var1.next();
    ...
    protected void markAvailableHeight(World par1World, Random par2Random, int par3)
    {
        ...
        while (var7.hasNext())
        {
            StructureComponentTFC var8 = (StructureComponentTFC)var7.next();
    ...
    protected void setRandomHeight(World par1World, Random par2Random, int par3, int par4)
    {
        ...
        while (var8.hasNext())
        {
            StructureComponentTFC var9 = (StructureComponentTFC)var8.next();
