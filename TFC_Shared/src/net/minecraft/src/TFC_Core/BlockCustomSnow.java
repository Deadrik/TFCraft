...
//	}
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		{      
			if(meta < 15 && par5Random.nextInt(10) == 0 && par1World.getBlockMaterial(par2, par3-1, par4) != Material.leaves) {
				par1World.setBlockMetadata(par2, par3, par4, meta+1);
			} else if(meta < 4 && par5Random.nextInt(10) == 0 && par1World.getBlockMaterial(par2, par3-1, par4) == Material.leaves)
			{
				par1World.setBlockMetadata(par2, par3, par4, meta+1);
			}
		}
		...
		{
			if(meta > 1 && par5Random.nextInt(10) == 0) {
				par1World.setBlockMetadata(par2, par3, par4, meta-1);
			} else if(meta == 1 && par5Random.nextInt(10) == 0) {
				par1World.setBlockWithNotify(par2, par3, par4, 0);
			}
		}
	}
